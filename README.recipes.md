...
#### **class [ArchiveApi](/recipe_modules/archive/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [AssertionsApi](/recipe_modules/assertions/api.py#56)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#29)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
&mdash; **def [archive](/recipe_modules/cas/api.py#78)(self, step_name, root, \*paths):**
...
&mdash; **def [download](/recipe_modules/cas/api.py#59)(self, step_name, digest, output_dir):**
...
&emsp; **@property**<br>&mdash; **def [instance](/recipe_modules/cas/api.py#31)(self):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#202)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#714)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#603)(self, root, ensure_file, name='ensure_installed'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#803)(self, package, version, executable_path=None):**
...
&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#780)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#749)(self, destination, package_name, version):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#682)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#657)(self, package_name, version, refs):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#630)(self, package_name, version, tags):**
...
#### **class [CommitPositionApi](/recipe_modules/commit_position/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [ContextApi](/recipe_modules/context/api.py#75)([RecipeApi](/recipe_engine/recipe_api.py#878)):**

&emsp; **@contextmanager**<br>&mdash; **def [\_\_call\_\_](/recipe_modules/context/api.py#100)(self, cwd=None, env_prefixes=None, env_suffixes=None, env=None, infra_steps=None, luciexe=None, realm=None):**
...
&emsp; **@property**<br>&mdash; **def [cwd](/recipe_modules/context/api.py#233)(self):**
...
&emsp; **@property**<br>&mdash; **def [env](/recipe_modules/context/api.py#243)(self):**
...
&emsp; **@property**<br>&mdash; **def [env\_prefixes](/recipe_modules/context/api.py#258)(self):**
...
&emsp; **@property**<br>&mdash; **def [env\_suffixes](/recipe_modules/context/api.py#272)(self):**
...
&emsp; **@property**<br>&mdash; **def [infra\_step](/recipe_modules/context/api.py#286)(self):**
...
&emsp; **@property**<br>&mdash; **def [luciexe](/recipe_modules/context/api.py#294)(self):**
...
&emsp; **@property**<br>&mdash; **def [realm](/recipe_modules/context/api.py#304)(self):**
...
#### **class [CQApi](/recipe_modules/cq/api.py#14)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
&emsp; **@property**<br>&mdash; **def [cl\_group\_key](/recipe_modules/cq/api.py#131)(self):**
...
&emsp; **@property**<br>&mdash; **def [do\_not\_retry\_build](/recipe_modules/cq/api.py#195)(self):**

&emsp; **@property**<br>&mdash; **def [equivalent\_cl\_group\_key](/recipe_modules/cq/api.py#144)(self):**
...
&emsp; **@property**<br>&mdash; **def [experimental](/recipe_modules/cq/api.py#63)(self):**
...
&mdash; **def [initialize](/recipe_modules/cq/api.py#45)(self):**

&emsp; **@property**<br>&mdash; **def [ordered\_gerrit\_changes](/recipe_modules/cq/api.py#88)(self):**
...
&emsp; **@property**<br>&mdash; **def [props\_for\_child\_build](/recipe_modules/cq/api.py#102)(self):**
...
&mdash; **def [record\_triggered\_build\_ids](/recipe_modules/cq/api.py#179)(self, \*build_ids):**
...
&mdash; **def [record\_triggered\_builds](/recipe_modules/cq/api.py#162)(self, \*builds):**
...
&mdash; **def [set\_do\_not\_retry\_build](/recipe_modules/cq/api.py#199)(self):**
...
&emsp; **@property**<br>&mdash; **def [state](/recipe_modules/cq/api.py#58)(self):**

CQ state pertaining to this recipe execution.

&emsp; **@property**<br>&mdash; **def [top\_level](/recipe_modules/cq/api.py#76)(self):**
...
&emsp; **@property**<br>&mdash; **def [triggered\_build\_ids](/recipe_modules/cq/api.py#157)(self):**
...
#### **class [FileApi](/recipe_modules/file/api.py#83)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
&mdash; **def [ensure\_directory](/recipe_modules/file/api.py#469)(self, name, dest, mode=511):**
...
&mdash; **def [filesizes](/recipe_modules/file/api.py#485)(self, name, files, test_data=None):**
...
&mdash; **def [flatten\_single\_directories](/recipe_modules/file/api.py#625)(self, name, path):**
...
&mdash; **def [glob\_paths](/recipe_modules/file/api.py#377)(self, name, source, pattern, include_hidden=False, test_data=()):**
...
&mdash; **def [listdir](/recipe_modules/file/api.py#439)(self, name, source, recursive=False, test_data=()):**
...
&mdash; **def [read\_json](/recipe_modules/file/api.py#307)(self, name, source, test_data=''):**
...
&mdash; **def [read\_proto](/recipe_modules/file/api.py#339)(self, name, source, msg_class, codec, test_proto=None):**
...
&mdash; **def [read\_raw](/recipe_modules/file/api.py#230)(self, name, source, test_data=''):**
...
&mdash; **def [read\_text](/recipe_modules/file/api.py#267)(self, name, source, test_data=''):**
...
&mdash; **def [remove](/recipe_modules/file/api.py#424)(self, name, source):**
...
&mdash; **def [rmcontents](/recipe_modules/file/api.py#524)(self, name, source):**
...
&mdash; **def [rmglob](/recipe_modules/file/api.py#542)(self, name, source, pattern, recursive=True, include_hidden=True):**
...
&mdash; **def [rmtree](/recipe_modules/file/api.py#507)(self, name, source):**
...
&mdash; **def [symlink](/recipe_modules/file/api.py#587)(self, name, source, linkname):**
...
&mdash; **def [symlink\_tree](/recipe_modules/file/api.py#604)(self, root):**
...
&mdash; **def [truncate](/recipe_modules/file/api.py#612)(self, name, path, size_mb=100):**
...
&mdash; **def [write\_json](/recipe_modules/file/api.py#324)(self, name, dest, data, indent=None):**
...
&mdash; **def [write\_proto](/recipe_modules/file/api.py#360)(self, name, dest, proto_msg, codec, include_log=True):**
...
&mdash; **def [write\_raw](/recipe_modules/file/api.py#250)(self, name, dest, data, include_log=True):**
...
&mdash; **def [write\_text](/recipe_modules/file/api.py#289)(self, name, dest, text_data, include_log=True):**
...
#### **class [FuturesApi](/recipe_modules/futures/api.py#42)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [IsolatedApi](/recipe_modules/isolated/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [JsonApi](/recipe_modules/json/api.py#95)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [LedApi](/recipe_modules/led/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [LegacyAnnotationApi](/recipe_modules/legacy_annotation/api.py#24)([RecipeApiPlain](/recipe_engine/recipe_api.py#730)):**
...
#### **class [MiloApi](/recipe_modules/milo/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#24)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#28)([RecipeApiPlain](/recipe_engine/recipe_api.py#730), collections.Mapping):**
...
#### **class [ProtoApi](/recipe_modules/proto/api.py#75)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [PythonApi](/recipe_modules/python/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [RandomApi](/recipe_modules/random/api.py#31)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [RawIOApi](/recipe_modules/raw_io/api.py#297)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [ResultDBAPI](/recipe_modules/resultdb/api.py#19)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [SchedulerApi](/recipe_modules/scheduler/api.py#26)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [ServiceAccountApi](/recipe_modules/service_account/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [StepApi](/recipe_modules/step/api.py#26)([RecipeApiPlain](/recipe_engine/recipe_api.py#730)):**
...
&emsp; **@recipe_api.composite_step**<br>&mdash; **def [\_\_call\_\_](/recipe_modules/step/api.py#508)(self, name, cmd, ok_ret=(0,), infra_step=False, wrapper=(), timeout=None, stdout=None, stderr=None, stdin=None, step_test_data=None, cost=_ResourceCost()):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#1161)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#1184)(self):**

Swarming bot ID executing this task.

&mdash; **def [collect](/recipe_modules/swarming/api.py#1324)(self, name, tasks, output_dir=None, task_output_stdout='json', timeout=None, eager=False, verbose=False):**
...
&mdash; **def [ensure\_client](/recipe_modules/swarming/api.py#1211)(self):**

&mdash; **def [initialize](/recipe_modules/swarming/api.py#1194)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1226)(self):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#1189)(self):**

This task's Swarming ID.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1258)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1269)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1277)(self, step_name, requests, verbose=False):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_server](/recipe_modules/swarming/api.py#1240)(self, server):**
...
#### **class [TimeApi](/recipe_modules/time/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [UuidApi](/recipe_modules/uuid/api.py#11)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [VersionApi](/recipe_modules/version/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#878)):**
...
#### **class [WarningApi](/recipe_modules/warning/api.py#12)([RecipeApiPlain](/recipe_engine/recipe_api.py#730)):**
