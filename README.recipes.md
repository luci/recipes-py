...
#### **class [AssertionsApi](/recipe_modules/assertions/api.py#56)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [BcidVerifierApi](/recipe_modules/bcid_verifier/api.py#22)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#43)([RecipeApi](/recipe_engine/recipe_api.py#433)):**

A module for interacting with buildbucket.

&mdash; **def [add\_tags\_to\_current\_build](/recipe_modules/buildbucket/api.py#285)(self, tags: list[common_pb2.StringPair]):**
...
&emsp; **@property**<br>&mdash; **def [backend\_hostname](/recipe_modules/buildbucket/api.py#1250)(self):**

Returns the backend hostname for the build.
If it is legacy swarming build then the swarming hostname will be returned.

&emsp; **@property**<br>&mdash; **def [backend\_task\_dimensions](/recipe_modules/buildbucket/api.py#1259)(self):**

Returns the task dimensions used by the task for the build.
    

&mdash; **def [backend\_task\_dimensions\_from\_build](/recipe_modules/buildbucket/api.py#1265)(self, build: (build_pb2.Build | None)=None):**

Returns the task dimensions for the provided build.
If no build is provided, then self.build will be used.

&emsp; **@property**<br>&mdash; **def [backend\_task\_id](/recipe_modules/buildbucket/api.py#1278)(self):**

Returns the task id of the task for the build.
    

&mdash; **def [backend\_task\_id\_from\_build](/recipe_modules/buildbucket/api.py#1284)(self, build: (build_pb2.Build | None)=None):**

Returns the task id of the task for the provided build.
If no build is provided, then self.build will be used.

&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#1232)(self):**

Returns bucket name in v1 format.

Mostly useful for scheduling new builds using v1 API.

&emsp; **@property**<br>&mdash; **def [build](/recipe_modules/buildbucket/api.py#137)(self):**
...
&mdash; **def [build\_url](/recipe_modules/buildbucket/api.py#201)(self, \*, host: (str | None)=None, build_id: ((int | str) | None)=None, build: (build_pb2.Build | None)=None):**

Returns url to a build. Defaults to current build.

&emsp; **@property**<br>&mdash; **def [builder\_cache\_path](/recipe_modules/buildbucket/api.py#312)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_full\_name](/recipe_modules/buildbucket/api.py#161)(self):**

Returns the full builder name: {project}/{bucket}/{builder}.

&emsp; **@property**<br>&mdash; **def [builder\_name](/recipe_modules/buildbucket/api.py#156)(self):**

Returns builder name. Shortcut for `.build.builder.builder`.

&emsp; **@property**<br>&mdash; **def [builder\_realm](/recipe_modules/buildbucket/api.py#171)(self):**
...
&mdash; **def [builder\_url](/recipe_modules/buildbucket/api.py#184)(self, \*, host: (str | None)=None, project: (str | None)=None, bucket: (str | None)=None, builder: (str | None)=None, build: (build_pb2.Build | None)=None):**

Returns url to a builder. Defaults to current builder.

&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#887)(self, build_id: (int | str), reason: (str | None)=None, step_name: (str | None)=None):**
...
&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#1022)(self, build_id: str, \*\*kwargs: Any):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#1036)(self, build_ids: Sequence[(int | str)], interval: (int | None)=None, timeout: (int | None)=None, step_name: (str | None)=None, raise_if_unsuccessful: bool=False, url_title_fn: (UrlTitleFunction | None)=None, mirror_status: bool=False, fields: Set[str]=DEFAULT_FIELDS, cost: (engine_types.ResourceCost | None)=None, eager: bool=False):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#993)(self, build_id: (int | str), url_title_fn: (UrlTitleFunction | None)=None, step_name: (str | None)=None, fields: Set[str]=DEFAULT_FIELDS, test_data: (build_pb2.Build | None)=None):**
...
&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#929)(self, build_ids: Sequence[(int | str)], url_title_fn: (UrlTitleFunction | None)=None, step_name: (str | None)=None, fields: Set[str]=DEFAULT_FIELDS, test_data: (Sequence[build_pb2.Build] | None)=None):**
...
&emsp; **@property**<br>&mdash; **def [gitiles\_commit](/recipe_modules/buildbucket/api.py#213)(self):**
...
&mdash; **def [hide\_current\_build\_in\_gerrit](/recipe_modules/buildbucket/api.py#306)(self):**

Hides the build in UI

&emsp; **@host.setter**<br>&mdash; **def [host](/recipe_modules/buildbucket/api.py#109)(self, value: str):**

&mdash; **def [is\_critical](/recipe_modules/buildbucket/api.py#224)(self, build: (build_pb2.Build | None)=None):**

Returns True if the build is critical. Build defaults to the current one.
    

&mdash; **def [list\_builders](/recipe_modules/buildbucket/api.py#693)(self, project: str, bucket: str, step_name: (str | None)=None):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#334)(self, schedule_build_requests: Sequence[builds_service_pb2.ScheduleBuildRequest], collect_interval: (int | None)=None, timeout: (int | None)=None, url_title_fn: (UrlTitleFunction | None)=None, step_name: (str | None)=None, raise_if_unsuccessful: bool=False, eager: bool=False):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#588)(self, schedule_build_requests: Sequence[builds_service_pb2.ScheduleBuildRequest], url_title_fn: (UrlTitleFunction | None)=None, step_name: (str | None)=None, include_sub_invs: bool=True):**
...
&mdash; **def [search\_with\_multiple\_predicates](/recipe_modules/buildbucket/api.py#793)(self, predicate: Sequence[builds_service_pb2.BuildPredicate], limit: (int | None)=None, url_title_fn: (UrlTitleFunction | None)=None, report_build: bool=True, step_name: (str | None)=None, fields: Set[str]=DEFAULT_FIELDS, timeout: (int | None)=None, test_data: (Callable[([], Sequence[build_pb2.Build])] | None)=None):**
...
&mdash; **def [set\_output\_gitiles\_commit](/recipe_modules/buildbucket/api.py#230)(self, gitiles_commit: common_pb2.GitilesCommit):**
...
&emsp; **@property**<br>&mdash; **def [shadowed\_bucket](/recipe_modules/buildbucket/api.py#1374)(self):**

&emsp; **@property**<br>&mdash; **def [swarming\_bot\_dimensions](/recipe_modules/buildbucket/api.py#1297)(self):**

Returns the swarming bot dimensions for the build.
    

&mdash; **def [swarming\_bot\_dimensions\_from\_build](/recipe_modules/buildbucket/api.py#1303)(self, build: (build_pb2.Build | None)=None):**

Returns the swarming bot dimensions for the provided build.
If no build is provided, then self.build will be used.

&emsp; **@property**<br>&mdash; **def [swarming\_parent\_run\_id](/recipe_modules/buildbucket/api.py#1326)(self):**

Returns the parent_run_id (swarming specific) used in the task.
    

&emsp; **@property**<br>&mdash; **def [swarming\_priority](/recipe_modules/buildbucket/api.py#1345)(self):**

Returns the priority (swarming specific) of the task.
    

&emsp; **@property**<br>&mdash; **def [swarming\_task\_service\_account](/recipe_modules/buildbucket/api.py#1359)(self):**

Returns the swarming specific service account used in the task.
    

&emsp; **@staticmethod**<br>&mdash; **def [tags](/recipe_modules/buildbucket/api.py#280)(\*\*tags: (list[str] | str)):**

Alias for tags in util.py. See doc there.

&mdash; **def [use\_service\_account\_key](/recipe_modules/buildbucket/api.py#123)(self, key_path: (config_types.Path | str)):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_host](/recipe_modules/buildbucket/api.py#113)(self, host: str):**
...
#### **class [CasApi](/recipe_modules/cas/api.py#14)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [CasInputApi](/recipe_modules/cas_input/api.py#22)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#246)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
&mdash; **def [acl\_check](/recipe_modules/cipd/api.py#351)(self, pkg_path: str, reader: bool=True, writer: bool=False, owner: bool=False):**
...
&mdash; **def [add\_instance\_link](/recipe_modules/cipd/api.py#646)(self, step_result: step_data.StepData):**

&mdash; **def [build](/recipe_modules/cipd/api.py#460)(self, input_dir: Path, output_package: Path, package_name: str, compression_level: (CompressionLevel | None)=None, install_mode: (InstallMode | None)=None, preserve_mtime: bool=False, preserve_writable: bool=False):**
...
&mdash; **def [build\_from\_pkg](/recipe_modules/cipd/api.py#436)(self, pkg_def: PackageDefinition, output_package: Path, compression_level: (CompressionLevel | None)=None):**
...
&mdash; **def [build\_from\_yaml](/recipe_modules/cipd/api.py#408)(self, pkg_def: Path, output_package: Path, pkg_vars: dict[(str, str)]=None, compression_level: (CompressionLevel | None)=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [cache\_dir](/recipe_modules/cipd/api.py#316)(self, directory: (Path | None)):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#690)(self, pkg_def: PackageDefinition, refs: (Sequence[str] | None)=None, tags: (Mapping[(str, str)] | None)=None, metadata: (Sequence[Metadata] | None)=None, compression_level: (CompressionLevel | None)=None, verification_timeout: (str | None)=None):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#651)(self, pkg_def: Path, refs: (Sequence[str] | None)=None, tags: (Mapping[(str, str)] | None)=None, metadata: (Sequence[Metadata] | None)=None, pkg_vars: (Mapping[(str, str)] | None)=None, compression_level: (CompressionLevel | None)=None, verification_timeout: (str | None)=None):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#937)(self, package_name: str, version: str, test_data_refs: (Sequence[str] | None)=None, test_data_tags: (Sequence[str] | None)=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#725)(self, root: Path, ensure_file: (EnsureFile | Path), name: str='ensure_installed'):**
...
&mdash; **def [ensure\_file\_resolve](/recipe_modules/cipd/api.py#772)(self, ensure_file: (EnsureFile | Path), name: str='cipd ensure-file-resolve'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#1069)(self, package: str, version: str, executable_path: (str | None)=None):**
...
&emsp; **@property**<br>&mdash; **def [executable](/recipe_modules/cipd/api.py#328)(self):**

&mdash; **def [instances](/recipe_modules/cipd/api.py#972)(self, package_name: str, limit: (int | None)=None):**
...
&mdash; **def [make\_link](/recipe_modules/cipd/api.py#643)(self, package: str, version: str):**

&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#1045)(self, root: Path, package_file: Path):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#1011)(self, destination: Path, package_name: str, version: str):**
...
&emsp; **@property**<br>&mdash; **def [platform](/recipe_modules/cipd/api.py#1145)(self):**

Returns the CIPD platform string, equivalent to '${platform}'.

&mdash; **def [register](/recipe_modules/cipd/api.py#572)(self, package_name: str, package_path: Path, refs: (Sequence[str] | None)=None, tags: (Mapping[(str, str)] | None)=None, metadata: Sequence[Metadata]=None, verification_timeout: (str | None)=None):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#900)(self, package_name: str, tag: str, test_instances: ((list[str] | int) | None)=None):**
...
&mdash; **def [set\_metadata](/recipe_modules/cipd/api.py#838)(self, package_name: str, version: str, metadata: list[Metadata]):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#869)(self, package_name: str, version: str, refs: list[str]):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#806)(self, package_name: str, version: str, tags: dict[(str, str)]):**
...
#### **class [CommitPositionApi](/recipe_modules/commit_position/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [CQApi](/recipe_modules/cq/api.py#20)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [CVApi](/recipe_modules/cv/api.py#20)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [DeferApi](/recipe_modules/defer/api.py#107)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [FileApi](/recipe_modules/file/api.py#98)([RecipeApi](/recipe_engine/recipe_api.py#433)):**

&mdash; **def [chmod](/recipe_modules/file/api.py#222)(self, name: str, path: (config_types.Path | str), mode: str, recursive: bool=False):**
...
&mdash; **def [compute\_hash](/recipe_modules/file/api.py#303)(self, name: str, paths: Sequence[(config_types.Path | str)], base_path: (config_types.Path | str), test_data: str=''):**
...
&mdash; **def [copy](/recipe_modules/file/api.py#155)(self, name: str, source: ((config_types.Path | str) | recipe_api.Placeholder), dest: ((config_types.Path | str) | recipe_api.Placeholder)):**
...
&mdash; **def [copytree](/recipe_modules/file/api.py#181)(self, name: str, source: (config_types.Path | str), dest: (config_types.Path | str), symlinks: bool=False, hardlink: bool=False, allow_override: bool=False):**
...
&mdash; **def [ensure\_directory](/recipe_modules/file/api.py#693)(self, name: str, dest: (config_types.Path | str), mode: int=511):**
...
&mdash; **def [file\_hash](/recipe_modules/file/api.py#270)(self, file_path: (config_types.Path | str), test_data: str=''):**
...
&mdash; **def [filesizes](/recipe_modules/file/api.py#715)(self, name: str, files: Sequence[(config_types.Path | str)], test_data: (Sequence[int] | None)=None):**
...
&mdash; **def [flatten\_single\_directories](/recipe_modules/file/api.py#889)(self, name: str, path: (config_types.Path | str)):**
...
&mdash; **def [listdir](/recipe_modules/file/api.py#654)(self, name: str, source: (config_types.Path | str), recursive: bool=False, test_data: Sequence[str]=(), include_log: bool=True):**
...
&mdash; **def [move](/recipe_modules/file/api.py#246)(self, name: str, source: (config_types.Path | str), dest: (config_types.Path | str)):**
...
&mdash; **def [read\_json](/recipe_modules/file/api.py#460)(self, name: str, source: (config_types.Path | str), test_data: Any='', include_log: bool=True):**
...
&mdash; **def [read\_proto](/recipe_modules/file/api.py#512)(self, name: str, source: (config_types.Path | str), msg_class: type[ProtoMessage], codec: ProtoCodec, test_proto: Any=None, include_log: bool=True, decoding_kwargs: (dict | None)=None):**
...
&mdash; **def [read\_raw](/recipe_modules/file/api.py#360)(self, name: str, source: (config_types.Path | str), test_data: bytes=''):**
...
&mdash; **def [read\_text](/recipe_modules/file/api.py#405)(self, name: str, source: (config_types.Path | str), test_data: str='', include_log: bool=True):**
...
&mdash; **def [remove](/recipe_modules/file/api.py#634)(self, name: str, source: (config_types.Path | str)):**
...
&mdash; **def [rmcontents](/recipe_modules/file/api.py#765)(self, name: str, source: (config_types.Path | str)):**
...
&mdash; **def [rmglob](/recipe_modules/file/api.py#788)(self, name: str, source: (config_types.Path | str), pattern: str, recursive: bool=True, include_hidden: bool=True):**
...
&mdash; **def [rmtree](/recipe_modules/file/api.py#743)(self, name: str, source: (config_types.Path | str)):**
...
&mdash; **def [symlink](/recipe_modules/file/api.py#840)(self, name: str, source: ((config_types.Path | str) | recipe_api.Placeholder), linkname: ((config_types.Path | str) | recipe_api.Placeholder)):**
...
&mdash; **def [symlink\_tree](/recipe_modules/file/api.py#863)(self, root: (config_types.Path | str)):**
...
&mdash; **def [truncate](/recipe_modules/file/api.py#871)(self, name: str, path: (config_types.Path | str), size_mb: int=100):**
...
&mdash; **def [write\_json](/recipe_modules/file/api.py#485)(self, name: str, dest: (config_types.Path | str), data: Any, indent: ((int | str) | None)=None, include_log: bool=True, sort_keys: bool=True):**
...
&mdash; **def [write\_proto](/recipe_modules/file/api.py#554)(self, name: str, dest: (config_types.Path | str), proto_msg: google.protobuf.message, codec: ProtoCodec, include_log: bool=True, encoding_kwargs: (dict | None)=None):**
...
&mdash; **def [write\_raw](/recipe_modules/file/api.py#385)(self, name: str, dest: (config_types.Path | str), data: bytes):**
...
&mdash; **def [write\_text](/recipe_modules/file/api.py#435)(self, name: str, dest: (config_types.Path | str), text_data: str, include_log: bool=True):**
...
&mdash; **def [populate\_source\_from\_current\_build](/recipe_modules/findings/api.py#169)(self, location: findings_pb.Location):**
...
&mdash; **def [upload\_findings](/recipe_modules/findings/api.py#47)(self, findings: list[findings_pb.Finding], step_name: (str | None)=None):**
...
#### **class [FuturesApi](/recipe_modules/futures/api.py#168)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#14)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&mdash; **def [input](/recipe_modules/json/api.py#160)(self, data, sort_keys=True):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&mdash; **def [output](/recipe_modules/json/api.py#172)(self, add_json_log=True, name=None, leak_to=None):**
...
#### **class [LedApi](/recipe_modules/led/api.py#23)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
&mdash; **def [\_\_call\_\_](/recipe_modules/led/api.py#216)(self, \*cmd: str):**

Runs led with the given arguments. Wraps result in a `LedResult`.

&emsp; **@property**<br>&mdash; **def [cipd\_input](/recipe_modules/led/api.py#199)(self):**
...
&mdash; **def [initialize](/recipe_modules/led/api.py#155)(self):**

&mdash; **def [inject\_input\_recipes](/recipe_modules/led/api.py#221)(self, led_result: LedResult):**
...
&emsp; **@property**<br>&mdash; **def [launched\_by\_led](/recipe_modules/led/api.py#176)(self):**

Whether the current build is a led job.

&emsp; **@property**<br>&mdash; **def [led\_build](/recipe_modules/led/api.py#171)(self):**

Whether the current build is a led job as a real Buildbucket build.

&emsp; **@property**<br>&mdash; **def [rbe\_cas\_input](/recipe_modules/led/api.py#190)(self):**
...
&emsp; **@property**<br>&mdash; **def [run\_id](/recipe_modules/led/api.py#181)(self):**
...
&emsp; **@property**<br>&mdash; **def [shadowed\_bucket](/recipe_modules/led/api.py#207)(self):**
...
&mdash; **def [trigger\_builder](/recipe_modules/led/api.py#234)(self, project_name: str, bucket_name: str, builder_name: str, properties: dict, use_payload: bool=False):**
...
#### **class [LegacyAnnotationApi](/recipe_modules/legacy_annotation/api.py#25)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [LuciAnalysisApi](/recipe_modules/luci_analysis/api.py#32)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [MiloApi](/recipe_modules/milo/api.py#19)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [PathApi](/recipe_modules/path/api.py#327)([RecipeApi](/recipe_engine/recipe_api.py#433)):**

&emsp; **@recipe_api.ignore_warnings('recipe_engine/CHECKOUT_DIR_DEPRECATED')**<br>&mdash; **def [\_\_contains\_\_](/recipe_modules/path/api.py#576)(self, pathname: NamedBasePathsType):**
...
&emsp; **@recipe_api.ignore_warnings('recipe_engine/CHECKOUT_DIR_DEPRECATED')**<br>&mdash; **def [abs\_to\_path](/recipe_modules/path/api.py#514)(self, abs_string_path: str):**
...
&mdash; **def [abspath](/recipe_modules/path/api.py#731)(self, path: (config_types.Path | str)):**

Equivalent to os.abspath.

&mdash; **def [assert\_absolute](/recipe_modules/path/api.py#452)(self, path: (config_types.Path | str)):**
...
&mdash; **def [basename](/recipe_modules/path/api.py#735)(self, path: (config_types.Path | str)):**

Equivalent to os.path.basename.

&emsp; **@property**<br>&mdash; **def [cache\_dir](/recipe_modules/path/api.py#665)(self):**
...
&mdash; **def [cast\_to\_path](/recipe_modules/path/api.py#699)(self, strpath: str):**
...
&emsp; **@checkout_dir.setter**<br>&mdash; **def [checkout\_dir](/recipe_modules/path/api.py#605)(self, path: config_types.Path):**

Sets the global variable `api.path.checkout_dir` to the given path.

    

&emsp; **@property**<br>&mdash; **def [cleanup\_dir](/recipe_modules/path/api.py#690)(self):**
...
&mdash; **def [dirname](/recipe_modules/path/api.py#739)(self, path: (config_types.Path | str)):**
...
&mdash; **def [exists](/recipe_modules/path/api.py#843)(self, path: ((config_types.Path | str) | util.InputPlaceholder)):**
...
&mdash; **def [expanduser](/recipe_modules/path/api.py#834)(self, path):**

Do not use this, use `api.path.home_dir` instead.

This ONLY handles `path` == "~", and returns `str(api.path.home_dir)`.

&emsp; **@property**<br>&mdash; **def [home\_dir](/recipe_modules/path/api.py#647)(self):**
...
&mdash; **def [initialize](/recipe_modules/path/api.py#427)(self):**

This is called by the recipe engine immediately after __init__(), but
with `self._paths_client` initialized.

&mdash; **def [isdir](/recipe_modules/path/api.py#856)(self, path: ((config_types.Path | str) | util.InputPlaceholder)):**
...
&mdash; **def [isfile](/recipe_modules/path/api.py#869)(self, path: ((config_types.Path | str) | util.InputPlaceholder)):**
...
&mdash; **def [join](/recipe_modules/path/api.py#758)(self, path, \*paths):**
...
&mdash; **def [mkdtemp](/recipe_modules/path/api.py#461)(self, prefix: str=tempfile.template):**
...
&mdash; **def [mkstemp](/recipe_modules/path/api.py#486)(self, prefix: str=tempfile.template):**
...
&mdash; **def [mock\_add\_directory](/recipe_modules/path/api.py#893)(self, path: config_types.Path):**

For testing purposes, mark that file |path| exists.

&mdash; **def [mock\_add\_file](/recipe_modules/path/api.py#889)(self, path: config_types.Path):**

For testing purposes, mark that file |path| exists.

&mdash; **def [mock\_add\_paths](/recipe_modules/path/api.py#882)(self, path: config_types.Path, kind: FileType=FileType.FILE):**

For testing purposes, mark that |path| exists.

&mdash; **def [mock\_copy\_paths](/recipe_modules/path/api.py#897)(self, source: config_types.Path, dest: config_types.Path):**

For testing purposes, copy |source| to |dest|.

&mdash; **def [mock\_remove\_paths](/recipe_modules/path/api.py#904)(self, path: config_types.Path, should_remove: Callable[([str], bool)]=(lambda p: True)):**
...
&mdash; **def [normpath](/recipe_modules/path/api.py#830)(self, path):**

Equivalent to os.path.normpath.

&emsp; **@property**<br>&mdash; **def [pardir](/recipe_modules/path/api.py#716)(self):**

Equivalent to os.pardir.

&emsp; **@property**<br>&mdash; **def [pathsep](/recipe_modules/path/api.py#726)(self):**

Equivalent to os.pathsep.

&mdash; **def [realpath](/recipe_modules/path/api.py#818)(self, path: (config_types.Path | str)):**

Equivalent to os.path.realpath.

&mdash; **def [relpath](/recipe_modules/path/api.py#822)(self, path, start):**
...
&emsp; **@property**<br>&mdash; **def [sep](/recipe_modules/path/api.py#721)(self):**

Equivalent to os.sep.

&mdash; **def [split](/recipe_modules/path/api.py#773)(self, path):**
...
&mdash; **def [splitext](/recipe_modules/path/api.py#794)(self, path: (config_types.Path | str)):**
...
&emsp; **@property**<br>&mdash; **def [start\_dir](/recipe_modules/path/api.py#636)(self):**
...
&emsp; **@property**<br>&mdash; **def [tmp\_base\_dir](/recipe_modules/path/api.py#656)(self):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#26)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#29)([RecipeApi](/recipe_engine/recipe_api.py#433), collections.abc.Mapping):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&emsp; **@staticmethod**<br>&mdash; **def [input](/recipe_modules/raw_io/api.py#308)(data, suffix='', name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&emsp; **@staticmethod**<br>&mdash; **def [input\_text](/recipe_modules/raw_io/api.py#335)(data, suffix='', name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output](/recipe_modules/raw_io/api.py#358)(suffix='', leak_to=None, name=None, add_output_log=False):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&mdash; **def [output\_dir](/recipe_modules/raw_io/api.py#396)(self, leak_to=None, name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#157)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_text](/recipe_modules/raw_io/api.py#378)(suffix='', leak_to=None, name=None, add_output_log=False):**
...
#### **class [ResultDBAPI](/recipe_modules/resultdb/api.py#30)([RecipeApi](/recipe_engine/recipe_api.py#433)):**

A module for interacting with ResultDB.

&mdash; **def [assert\_enabled](/recipe_modules/resultdb/api.py#52)(self):**

&mdash; **def [config\_test\_presentation](/recipe_modules/resultdb/api.py#875)(self, column_keys=(), grouping_keys=('status',)):**
...
&mdash; **def [exonerate](/recipe_modules/resultdb/api.py#154)(self, test_exonerations, step_name=None):**
...
&mdash; **def [get\_invocation\_instructions](/recipe_modules/resultdb/api.py#129)(self, inv_name=None, step_name=None):**
...
&mdash; **def [invocation\_ids](/recipe_modules/resultdb/api.py#196)(self, inv_names):**
...
&mdash; **def [query](/recipe_modules/resultdb/api.py#211)(self, inv_ids, variants_with_unexpected_results=False, merge=False, limit=None, step_name=None, tr_fields=None, test_invocations=None, test_regex=None):**
...
&mdash; **def [query\_new\_test\_variants](/recipe_modules/resultdb/api.py#503)(self, invocation: str, baseline: str, step_name: str=None, step_test_data: dict=None):**
...
&mdash; **def [query\_test\_result\_statistics](/recipe_modules/resultdb/api.py#291)(self, invocations=None, step_name=None):**
...
&mdash; **def [query\_test\_results](/recipe_modules/resultdb/api.py#378)(self, invocations, test_id_regexp=None, variant_predicate=None, field_mask_paths=None, page_size=100, page_token=None, step_name=None):**
...
&mdash; **def [query\_test\_variants](/recipe_modules/resultdb/api.py#440)(self, invocations, test_variant_status=None, field_mask_paths=None, page_size=100, page_token=None, step_name=None):**
...
&mdash; **def [unwrap](/recipe_modules/resultdb/api.py#861)(self, cmd: list[str]):**
...
&mdash; **def [update\_invocation](/recipe_modules/resultdb/api.py#541)(self, parent_inv='', step_name=None, source_spec=None, is_source_spec_final=None, baseline_id=None, instructions=None, raise_on_failure=True):**
...
&mdash; **def [upload\_invocation\_artifacts](/recipe_modules/resultdb/api.py#324)(self, artifacts, parent_inv=None, step_name=None):**
...
&mdash; **def [wrap](/recipe_modules/resultdb/api.py#664)(self, cmd, module_name='', module_scheme='', base_variant=None, test_location_base='', base_tags=None, coerce_negative_duration=False, include=False, realm='', location_tags_file='', require_build_inv=True, exonerate_unexpected_pass=False, inv_properties='', inv_properties_file='', inherit_sources=False, sources='', sources_file='', baseline_id='', inv_extended_properties_dir='', previous_test_id_prefix=None, test_id_prefix='', shorten_ids=False):**
...
#### **class [RuntimeApi](/recipe_modules/runtime/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [SchedulerApi](/recipe_modules/scheduler/api.py#29)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [ServiceAccountApi](/recipe_modules/service_account/api.py#18)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [StepApi](/recipe_modules/step/api.py#30)([RecipeApi](/recipe_engine/recipe_api.py#433)):**

&emsp; **@property**<br>&mdash; **def [InfraFailure](/recipe_modules/step/api.py#149)(self):**
...
&emsp; **@property**<br>&mdash; **def [MAX\_CPU](/recipe_modules/step/api.py#121)(self):**

Returns the maximum number of millicores this system has.

&emsp; **@property**<br>&mdash; **def [MAX\_MEMORY](/recipe_modules/step/api.py#126)(self):**

Returns the maximum amount of memory on the system in MB.

&mdash; **def [ResourceCost](/recipe_modules/step/api.py#54)(self, cpu=500, memory=50, disk=0, net=0):**
...
&emsp; **@property**<br>&mdash; **def [StepFailure](/recipe_modules/step/api.py#131)(self):**
...
&emsp; **@property**<br>&mdash; **def [StepWarning](/recipe_modules/step/api.py#143)(self):**
...
&emsp; **@property**<br>&mdash; **def [active\_result](/recipe_modules/step/api.py#159)(self):**
...
&mdash; **def [close\_non\_nest\_step](/recipe_modules/step/api.py#192)(self):**
...
&mdash; **def [empty](/recipe_modules/step/api.py#302)(self, name, status='SUCCESS', step_text=None, log_text=None, log_name='stdout', raise_on_failure=True):**
...
&mdash; **def [funcall](/recipe_modules/step/api.py#736)(self, name, func, \*args, \*\*kwargs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [nest](/recipe_modules/step/api.py#202)(self, name, status='worst'):**
...
&mdash; **def [raise\_on\_failure](/recipe_modules/step/api.py#445)(self, result, status_override=None):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#1255)(self):**

Swarming bot ID executing this task.

&mdash; **def [collect](/recipe_modules/swarming/api.py#1398)(self, name, tasks, output_dir=None, task_output_stdout='json', timeout=None, eager=False, verbose=False):**
...
&emsp; **@property**<br>&mdash; **def [current\_server](/recipe_modules/swarming/api.py#1265)(self):**

Swarming server executing this task.

&mdash; **def [ensure\_client](/recipe_modules/swarming/api.py#1292)(self):**

&mdash; **def [initialize](/recipe_modules/swarming/api.py#1270)(self):**

&mdash; **def [list\_bots](/recipe_modules/swarming/api.py#1541)(self, step_name, dimensions=None, fields=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1308)(self):**
...
&mdash; **def [show\_request](/recipe_modules/swarming/api.py#1504)(self, name, task):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#1260)(self):**

This task's Swarming ID.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1322)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1333)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1341)(self, step_name, requests, verbose=False, server=None):**
...
#### **class [TimeApi](/recipe_modules/time/api.py#94)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#30)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [UuidApi](/recipe_modules/uuid/api.py#13)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [VersionApi](/recipe_modules/version/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
#### **class [WarningApi](/recipe_modules/warning/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#433)):**
...
&mdash; **def [RunSteps](/recipes/engine_tests/expect_exception.py#18)(api):**

&mdash; **def [my\_function](/recipes/engine_tests/expect_exception.py#14)():**
...
&mdash; **def [RunSteps](/recipes/engine_tests/expect_exceptions.py#25)(api):**

&mdash; **def [my\_function](/recipes/engine_tests/expect_exceptions.py#13)():**
...
&mdash; **def [RunSteps](/recipes/engine_tests/recipe_test_data.py#16)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/file/examples/copytree.py#18)(api, properties):**
...
&mdash; **def [RunSteps](/recipe_modules/findings/tests/infer_source.py#22)(api, expected_loc):**
...
&mdash; **def [RunSteps](/recipe_modules/findings/tests/upload_findings.py#20)(api, props):**
...
&emsp; **@recipe_api.ignore_warnings('recipe_engine/JSON_READ_DEPRECATED')**<br>&mdash; **def [RunSteps](/recipe_modules/json/examples/full.py#23)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/led/tests/trigger_build_with_payload.py#17)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/luci_analysis/tests/test_generate_stability_response.py#17)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/milo/examples/full.py#14)(api):**
...
&emsp; **@recipe_api.ignore_warnings('recipe_engine/CHECKOUT_DIR_DEPRECATED')**<br>&mdash; **def [RunSteps](/recipe_modules/path/examples/full.py#20)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/path/tests/cast_to_path.py#16)(api):**
...
&emsp; **@recipe_api.ignore_warnings('recipe_engine/CHECKOUT_DIR_DEPRECATED')**<br>&mdash; **def [RunSteps](/recipe_modules/path/tests/dynamic_paths.py#13)(api):**
...
&emsp; **@recipe_api.ignore_warnings('recipe_engine/CHECKOUT_DIR_DEPRECATED')**<br>&mdash; **def [RunSteps](/recipe_modules/path/tests/exists.py#16)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/platform/examples/full.py#12)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/properties/examples/full.py#24)(api, props, env_props):**
...
&mdash; **def [RunSteps](/recipe_modules/resultdb/examples/get_invocation_instructions.py#18)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/step/tests/drop_expectation.py#17)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/step/tests/empty.py#23)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/swarming/examples/full.py#18)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/swarming/tests/collect_errors.py#16)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/swarming/tests/list_tasks.py#16)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/tricium/examples/wrapper.py#22)(api):**
...
&mdash; **def [RunSteps](/recipe_modules/tricium/tests/enforce_comments_num_limit.py#23)(api, props):**
