...
&emsp; **@property**<br>&mdash; **def [build](/recipe_modules/buildbucket/api.py#96)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#851)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#856)(self):**

DEPRECATED, use build.input instead.

&mdash; **def [build\_url](/recipe_modules/buildbucket/api.py#120)(self, host=None, build_id=None):**

Returns url to a build. Defaults to current build.

&emsp; **@property**<br>&mdash; **def [builder\_cache\_path](/recipe_modules/buildbucket/api.py#226)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#861)(self):**

Deprecated. Use build.builder instead.

&emsp; **@property**<br>&mdash; **def [builder\_name](/recipe_modules/buildbucket/api.py#115)(self):**
...
&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#663)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#676)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#642)(self, build_id, url_title_fn=None, step_name=None):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#659)(self, build_id, \*\*kwargs):**
...
&emsp; **@host.setter**<br>&mdash; **def [host](/recipe_modules/buildbucket/api.py#74)(self, value):**

&mdash; **def [is\_critical](/recipe_modules/buildbucket/api.py#136)(self, build=None):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#257)(self, schedule_build_requests, collect_interval=None, timeout=None, url_title_fn=None, step_name=None, raise_if_unsuccessful=False):**
...
&mdash; **def [schedule\_request](/recipe_modules/buildbucket/api.py#285)(self, builder, project=None, bucket=None, properties=None, experimental=None, gitiles_commit=None, gerrit_changes=None, tags=None, inherit_buildsets=True, dimensions=None, priority=None, critical=None, exe_cipd_version=None):**
...
&mdash; **def [set\_buildbucket\_host](/recipe_modules/buildbucket/api.py#78)(self, host):**

DEPRECATED. Use host property.

&mdash; **def [set\_output\_gitiles\_commit](/recipe_modules/buildbucket/api.py#179)(self, gitiles_commit):**
...
&mdash; **def [tags](/recipe_modules/buildbucket/api.py#222)(self, \*\*tags):**

Alias for tags in util.py. See doc there.

&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#142)(self):**

A dict of tags (key -> value) derived from current (parent) build for a
child build.

&mdash; **def [use\_service\_account\_key](/recipe_modules/buildbucket/api.py#82)(self, key_path):**
