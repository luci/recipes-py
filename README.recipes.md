...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#713)(self, build_id, reason=' ', step_name=None):**
...
&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#815)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#828)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False, fields=DEFAULT_FIELDS):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#794)(self, build_id, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#751)(self, build_ids, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [list\_builders](/recipe_modules/buildbucket/api.py#611)(self, project, bucket, step_name=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#637)(self, predicate, limit=None, url_title_fn=None, report_build=True, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [ensure\_directory](/recipe_modules/file/api.py#554)(self, name, dest, mode=511):**
...
&mdash; **def [filesizes](/recipe_modules/file/api.py#570)(self, name, files, test_data=None):**
...
&mdash; **def [flatten\_single\_directories](/recipe_modules/file/api.py#710)(self, name, path):**
...
&mdash; **def [listdir](/recipe_modules/file/api.py#524)(self, name, source, recursive=False, test_data=()):**
...
&mdash; **def [rmcontents](/recipe_modules/file/api.py#609)(self, name, source):**
...
&mdash; **def [rmglob](/recipe_modules/file/api.py#627)(self, name, source, pattern, recursive=True, include_hidden=True):**
...
&mdash; **def [rmtree](/recipe_modules/file/api.py#592)(self, name, source):**
...
&mdash; **def [symlink](/recipe_modules/file/api.py#672)(self, name, source, linkname):**
...
&mdash; **def [symlink\_tree](/recipe_modules/file/api.py#689)(self, root):**
...
&mdash; **def [truncate](/recipe_modules/file/api.py#697)(self, name, path, size_mb=100):**
...
&mdash; **def [\_\_call\_\_](/recipe_modules/led/api.py#166)(self, \*cmd):**

Runs led with the given arguments. Wraps result in a `LedResult`.

&emsp; **@property**<br>&mdash; **def [cipd\_input](/recipe_modules/led/api.py#158)(self):**
...
&mdash; **def [initialize](/recipe_modules/led/api.py#120)(self):**

&mdash; **def [inject\_input\_recipes](/recipe_modules/led/api.py#170)(self, led_result):**
...
&emsp; **@property**<br>&mdash; **def [launched\_by\_led](/recipe_modules/led/api.py#136)(self):**

Whether the current build is a led job.

&emsp; **@property**<br>&mdash; **def [rbe\_cas\_input](/recipe_modules/led/api.py#149)(self):**
...
&emsp; **@property**<br>&mdash; **def [run\_id](/recipe_modules/led/api.py#141)(self):**

A unique string identifier for this led job.

If the current build is *not* a led job, value will be an empty string.

&mdash; **def [trigger\_builder](/recipe_modules/led/api.py#195)(self, project_name, bucket_name, builder_name, properties):**
