...
[DEPS](/recipe_modules/buildbucket/__init__.py#5): [json](#recipe_modules-json), [path](#recipe_modules-path), [platform](#recipe_modules-platform), [raw\_io](#recipe_modules-raw_io), [runtime](#recipe_modules-runtime), [step](#recipe_modules-step), [uuid](#recipe_modules-uuid)
...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#33)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
&emsp; **@property**<br>&mdash; **def [build](/recipe_modules/buildbucket/api.py#103)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#863)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#868)(self):**

DEPRECATED, use build.input instead.

&mdash; **def [build\_url](/recipe_modules/buildbucket/api.py#127)(self, host=None, build_id=None):**

Returns url to a build. Defaults to current build.

&emsp; **@property**<br>&mdash; **def [builder\_cache\_path](/recipe_modules/buildbucket/api.py#233)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#873)(self):**

Deprecated. Use build.builder instead.

&emsp; **@property**<br>&mdash; **def [builder\_name](/recipe_modules/buildbucket/api.py#122)(self):**

Returns builder name. Shortcut for `.build.builder.builder`.

&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#612)(self, build_id, \*\*kwargs):**

&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#675)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#688)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#654)(self, build_id, url_title_fn=None, step_name=None):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#671)(self, build_id, \*\*kwargs):**

DEPRECATED. Use get().

&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#615)(self, build_ids, url_title_fn=None, step_name=None):**
...
&emsp; **@host.setter**<br>&mdash; **def [host](/recipe_modules/buildbucket/api.py#81)(self, value):**

&mdash; **def [is\_critical](/recipe_modules/buildbucket/api.py#143)(self, build=None):**

Returns True if the build is critical. Build defaults to the current one.
    

&mdash; **def [put](/recipe_modules/buildbucket/api.py#516)(self, builds, \*\*kwargs):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#440)(self, schedule_build_requests, url_title_fn=None, step_name=None):**
...
&mdash; **def [schedule\_request](/recipe_modules/buildbucket/api.py#292)(self, builder, project=None, bucket=None, properties=None, experimental=None, gitiles_commit=None, gerrit_changes=None, tags=None, inherit_buildsets=True, dimensions=None, priority=_INHERIT, critical=None, exe_cipd_version=None):**
...
* priority (int|NoneType): Swarming task priority.
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#551)(self, predicate, limit=None, url_title_fn=None, step_name=None):**
...
&mdash; **def [set\_buildbucket\_host](/recipe_modules/buildbucket/api.py#85)(self, host):**

DEPRECATED. Use host property.

&mdash; **def [set\_output\_gitiles\_commit](/recipe_modules/buildbucket/api.py#186)(self, gitiles_commit):**
...
&mdash; **def [tags](/recipe_modules/buildbucket/api.py#229)(self, \*\*tags):**

Alias for tags in util.py. See doc there.

&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#149)(self):**

A dict of tags (key -> value) derived from current (parent) build for a
child build.

&mdash; **def [use\_service\_account\_key](/recipe_modules/buildbucket/api.py#89)(self, key_path):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#23)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#896)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#918)(self):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#923)(self):**
...
#### **class [TimeApi](/recipe_modules/time/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
#### **class [UuidApi](/recipe_modules/uuid/api.py#11)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
[DEPS](/recipe_modules/buildbucket/tests/build.py#16): [buildbucket](#recipe_modules-buildbucket), [properties](#recipe_modules-properties), [step](#recipe_modules-step)

&mdash; **def [RunSteps](/recipe_modules/buildbucket/tests/build.py#23)(api):**
