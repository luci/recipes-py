...
&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#999)(self):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#266)([RecipeApi](/recipe_engine/recipe_api.py#902)):**
...
&mdash; **def [acl\_check](/recipe_modules/cipd/api.py#359)(self, pkg_path, reader=True, writer=False, owner=False):**
...
&mdash; **def [add\_instance\_link](/recipe_modules/cipd/api.py#620)(self, step_result):**

&mdash; **def [build](/recipe_modules/cipd/api.py#454)(self, input_dir, output_package, package_name, compression_level=None, install_mode=None, preserve_mtime=False, preserve_writable=False):**
...
&mdash; **def [build\_from\_pkg](/recipe_modules/cipd/api.py#434)(self, pkg_def, output_package, compression_level=None):**
...
&mdash; **def [build\_from\_yaml](/recipe_modules/cipd/api.py#408)(self, pkg_def, output_package, pkg_vars=None, compression_level=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [cache\_dir](/recipe_modules/cipd/api.py#332)(self, directory):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#664)(self, pkg_def, refs=None, tags=None, metadata=None, compression_level=None, verification_timeout=None):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#626)(self, pkg_def, refs=None, tags=None, metadata=None, pkg_vars=None, compression_level=None, verification_timeout=None):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#883)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#699)(self, root, ensure_file, name='ensure_installed'):**
...
&mdash; **def [ensure\_file\_resolve](/recipe_modules/cipd/api.py#741)(self, ensure_file, name='cipd ensure-file-resolve'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#1009)(self, package: str, version: str, executable_path: Optional[str]=None):**
...
&mdash; **def [instances](/recipe_modules/cipd/api.py#918)(self, package_name, limit=None):**
...
&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#985)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#955)(self, destination, package_name, version):**
...
&mdash; **def [register](/recipe_modules/cipd/api.py#550)(self, package_name, package_path, refs=None, tags=None, metadata=None, verification_timeout=None):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#851)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_metadata](/recipe_modules/cipd/api.py#799)(self, package_name, version, metadata):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#825)(self, package_name, version, refs):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#771)(self, package_name, version, tags):**
...
&mdash; **def [allow\_reuse\_for](/recipe_modules/cv/api.py#217)(self, \*modes):**
...
&emsp; **@property**<br>&mdash; **def [allowed\_reuse\_modes](/recipe_modules/cv/api.py#213)(self):**
...
&emsp; **@property**<br>&mdash; **def [do\_not\_retry\_build](/recipe_modules/cv/api.py#195)(self):**
...
&emsp; **@property**<br>&mdash; **def [owner\_is\_googler](/recipe_modules/cv/api.py#235)(self):**
...
&mdash; **def [record\_triggered\_build\_ids](/recipe_modules/cv/api.py#179)(self, \*build_ids):**
...
&mdash; **def [record\_triggered\_builds](/recipe_modules/cv/api.py#163)(self, \*builds):**
...
&mdash; **def [set\_do\_not\_retry\_build](/recipe_modules/cv/api.py#199)(self):**
...
&emsp; **@property**<br>&mdash; **def [triggered\_build\_ids](/recipe_modules/cv/api.py#158)(self):**
...
#### **class [StepApi](/recipe_modules/step/api.py#26)([RecipeApiPlain](/recipe_engine/recipe_api.py#751)):**
