...
#### **class [ContextApi](/recipe_modules/context/api.py#L49)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&emsp; **@contextmanager**<br>&mdash; **def [\_\_call\_\_](/recipe_modules/context/api.py#L63)(self, cwd=None, env_prefixes=None, env=None, increment_nest_level=None, infra_steps=None, name_prefix=None):**
...
&emsp; **@property**<br>&mdash; **def [cwd](/recipe_modules/context/api.py#L191)(self):**
...
&emsp; **@property**<br>&mdash; **def [env](/recipe_modules/context/api.py#L201)(self):**
...
&emsp; **@property**<br>&mdash; **def [env\_prefixes](/recipe_modules/context/api.py#L216)(self):**
...
&emsp; **@property**<br>&mdash; **def [infra\_step](/recipe_modules/context/api.py#L230)(self):**

Returns the current value of the infra_step setting.

**Returns (bool)** - True iff steps are currently considered infra steps.

&emsp; **@property**<br>&mdash; **def [name\_prefix](/recipe_modules/context/api.py#L238)(self):**
...
&emsp; **@property**<br>&mdash; **def [nest\_level](/recipe_modules/context/api.py#L247)(self):**
...
#### **class [FileApi](/recipe_modules/file/api.py#L17)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#L16)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&mdash; **def [\_\_call\_\_](/recipe_modules/generator_script/api.py#L43)(self, path_to_script, \*args):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#L18)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**
...
&emsp; **@property**<br>&mdash; **def [arch](/recipe_modules/platform/api.py#L93)(self):**
...
&emsp; **@property**<br>&mdash; **def [cpu\_count](/recipe_modules/platform/api.py#L102)(self):**

The number of CPU cores, according to multiprocessing.cpu_count().

&emsp; **@property**<br>&mdash; **def [is\_linux](/recipe_modules/platform/api.py#L69)(self):**

Returns True iff the recipe is running on Linux.

&emsp; **@property**<br>&mdash; **def [is\_mac](/recipe_modules/platform/api.py#L64)(self):**

Returns True iff the recipe is running on OS X.

&emsp; **@property**<br>&mdash; **def [is\_win](/recipe_modules/platform/api.py#L59)(self):**

Returns True iff the recipe is running on Windows.

&emsp; **@property**<br>&mdash; **def [name](/recipe_modules/platform/api.py#L74)(self):**
...
&emsp; **@staticmethod**<br>&mdash; **def [normalize\_platform\_name](/recipe_modules/platform/api.py#L107)(plat):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#L28)([RecipeApiPlain](/recipe_engine/recipe_api.py#L752), collections.Mapping):**

PropertiesApi implements all the standard Mapping functions, so you
can use it like a read-only dict.

&mdash; **def [legacy](/recipe_modules/properties/api.py#L54)(self):**

DEPRECATED: Returns a set of properties, possibly used by legacy
scripts.

&mdash; **def [thaw](/recipe_modules/properties/api.py#L69)(self):**
...
#### **class [PythonApi](/recipe_modules/python/api.py#L17)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&mdash; **def [\_\_call\_\_](/recipe_modules/python/api.py#L18)(self, name, script, args=None, unbuffered=True, venv=None, \*\*kwargs):**
...
&mdash; **def [failing\_step](/recipe_modules/python/api.py#L110)(self, name, text, as_log=None):**

Runs a succeeding step (exits 1).

&mdash; **def [inline](/recipe_modules/python/api.py#L63)(self, name, program, add_python_log=True, \*\*kwargs):**
...
&mdash; **def [result\_step](/recipe_modules/python/api.py#L91)(self, name, text, retcode, as_log=None):**

Runs a no-op step that exits with a specified return code.

&mdash; **def [succeeding\_step](/recipe_modules/python/api.py#L106)(self, name, text, as_log=None):**
...
#### **class [RawIOApi](/recipe_modules/raw_io/api.py#L173)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&emsp; **@[returns\_placeholder](/recipe_engine/util.py#L119)**<br>&emsp; **@staticmethod**<br>&mdash; **def [input](/recipe_modules/raw_io/api.py#L174)(data, suffix=''):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#L119)**<br>&emsp; **@staticmethod**<br>&mdash; **def [input\_text](/recipe_modules/raw_io/api.py#L192)(data, suffix=''):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#L119)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output](/recipe_modules/raw_io/api.py#L205)(suffix='', leak_to=None, name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#L119)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_dir](/recipe_modules/raw_io/api.py#L231)(suffix='', leak_to=None, name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#L119)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_text](/recipe_modules/raw_io/api.py#L219)(suffix='', leak_to=None, name=None):**
...
#### **class [StepApi](/recipe_modules/step/api.py#L19)([RecipeApiPlain](/recipe_engine/recipe_api.py#L752)):**

&emsp; **@property**<br>&mdash; **def [InfraFailure](/recipe_modules/step/api.py#L52)(self):**
...
&emsp; **@property**<br>&mdash; **def [StepFailure](/recipe_modules/step/api.py#L34)(self):**
...
&emsp; **@property**<br>&mdash; **def [StepTimeout](/recipe_modules/step/api.py#L62)(self):**

StepTimeout is a subclass of StepFailure and is raised when a step times
out.

&emsp; **@property**<br>&mdash; **def [StepWarning](/recipe_modules/step/api.py#L46)(self):**

StepWarning is a subclass of StepFailure, and will translate to a yellow
build.

&emsp; **@recipe_api.composite_step**<br>&mdash; **def [\_\_call\_\_](/recipe_modules/step/api.py#L128)(self, name, cmd, ok_ret=None, infra_step=False, wrapper=(), timeout=None, allow_subannotations=None, trigger_specs=None, stdout=None, stderr=None, stdin=None, step_test_data=None):**
...
&emsp; **@property**<br>&mdash; **def [active\_result](/recipe_modules/step/api.py#L68)(self):**
...
&emsp; **@property**<br>&mdash; **def [defer\_results](/recipe_modules/step/api.py#L123)(self):**

See recipe_api.py for docs. 

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [nest](/recipe_modules/step/api.py#L101)(self, name):**
...
#### **class [TempfileApi](/recipe_modules/tempfile/api.py#L12)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [temp\_dir](/recipe_modules/tempfile/api.py#L13)(self, prefix):**
...
#### **class [TimeApi](/recipe_modules/time/api.py#L12)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&mdash; **def [time](/recipe_modules/time/api.py#L21)(self):**

Return current timestamp as a float number of seconds since epoch.

&mdash; **def [utcnow](/recipe_modules/time/api.py#L29)(self):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#L15)([RecipeApi](/recipe_engine/recipe_api.py#L884)):**

&mdash; **def [get\_file](/recipe_modules/url/api.py#L130)(self, url, path, step_name=None, headers=None, transient_retry=True, strip_prefix=None, timeout=None):**
...
&mdash; **def [get\_json](/recipe_modules/url/api.py#L186)(self, url, step_name=None, headers=None, transient_retry=True, strip_prefix=None, log=False, timeout=None, default_test_data=None):**
...
&mdash; **def [get\_text](/recipe_modules/url/api.py#L158)(self, url, step_name=None, headers=None, transient_retry=True, timeout=None, default_test_data=None):**
...
&mdash; **def [join](/recipe_modules/url/api.py#L94)(self, \*parts):**
...
&mdash; **def [validate\_url](/recipe_modules/url/api.py#L110)(self, v):**
