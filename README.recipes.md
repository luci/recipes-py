...
&mdash; **def [acl\_check](/recipe_modules/cipd/api.py#211)(self, pkg_path, reader=True, writer=False, owner=False):**
...
&mdash; **def [build](/recipe_modules/cipd/api.py#287)(self, input_dir, output_package, package_name, install_mode=None):**
...
&mdash; **def [build\_from\_pkg](/recipe_modules/cipd/api.py#269)(self, pkg_def, output_package):**
...
&mdash; **def [build\_from\_yaml](/recipe_modules/cipd/api.py#252)(self, pkg_def, output_package):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#389)(self, pkg_def, refs=(), tags={}):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#371)(self, pkg_def, refs=(), tags={}):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#516)(self, package_name, version, test_data_refs=(), test_data_tags={}):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#408)(self, root, packages):**
...
&mdash; **def [register](/recipe_modules/cipd/api.py#319)(self, package_name, package_path, refs=(), tags={}):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#490)(self, package_name, tag):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#462)(self, package_name, version, refs):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#432)(self, package_name, version, tags):**
