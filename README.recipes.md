...
&mdash; **def [run\_legacy](/recipe_modules/tricium/api.py#134)(self, analyzers, input_base, affected_files, commit_message, emit=True):**
...
&mdash; **def [write\_comments](/recipe_modules/tricium/api.py#109)(self):**
