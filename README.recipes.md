...
#### **class [ArchiveApi](/recipe_modules/archive/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [AssertionsApi](/recipe_modules/assertions/api.py#55)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#32)([RecipeApi](/recipe_engine/recipe_api.py#883)):**

A module for interacting with buildbucket.

&mdash; **def [add\_tags\_to\_current\_build](/recipe_modules/buildbucket/api.py#281)(self, tags):**
...
&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#799)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#812)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False, fields=DEFAULT_FIELDS):**
...
&mdash; **def [hide\_current\_build\_in\_gerrit](/recipe_modules/buildbucket/api.py#302)(self):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#327)(self, schedule_build_requests, collect_interval=None, timeout=None, url_title_fn=None, step_name=None, raise_if_unsuccessful=False):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#621)(self, predicate, limit=None, url_title_fn=None, report_build=True, step_name=None, fields=DEFAULT_FIELDS):**
...
&emsp; **@staticmethod**<br>&mdash; **def [tags](/recipe_modules/buildbucket/api.py#276)(\*\*tags):**

Alias for tags in util.py. See doc there.

&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#190)(self):**
...
#### **class [CasApi](/recipe_modules/cas/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [CasInputApi](/recipe_modules/cas_input/api.py#20)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#265)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#852)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#978)(self, package, version, executable_path=None):**
...
&mdash; **def [instances](/recipe_modules/cipd/api.py#887)(self, package_name, limit=None):**
...
&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#954)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#924)(self, destination, package_name, version):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#820)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_metadata](/recipe_modules/cipd/api.py#768)(self, package_name, version, metadata):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#794)(self, package_name, version, refs):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#740)(self, package_name, version, tags):**
...
#### **class [CommitPositionApi](/recipe_modules/commit_position/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [ContextApi](/recipe_modules/context/api.py#80)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [CQApi](/recipe_modules/cq/api.py#18)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [FileApi](/recipe_modules/file/api.py#87)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [GolangApi](/recipe_modules/golang/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [JsonApi](/recipe_modules/json/api.py#122)([RecipeApi](/recipe_engine/recipe_api.py#883)):**

&emsp; **@staticmethod**<br>&mdash; **def [dumps](/recipe_modules/json/api.py#123)(\*args, \*\*kwargs):**

Works like `json.dumps`.

&emsp; **@[returns\_placeholder](/recipe_engine/util.py#156)**<br>&mdash; **def [input](/recipe_modules/json/api.py#146)(self, data):**

A placeholder which will expand to a file path containing <data>.

&mdash; **def [is\_serializable](/recipe_modules/json/api.py#138)(self, obj):**

Returns True if the object is JSON-serializable.

&emsp; **@staticmethod**<br>&mdash; **def [loads](/recipe_modules/json/api.py#128)(data, \*\*kwargs):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#156)**<br>&mdash; **def [output](/recipe_modules/json/api.py#151)(self, add_json_log=True, name=None, leak_to=None):**
...
&mdash; **def [read](/recipe_modules/json/api.py#166)(self, name, path, add_json_log=True, output_name=None, \*\*kwargs):**
...
#### **class [LedApi](/recipe_modules/led/api.py#21)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [LegacyAnnotationApi](/recipe_modules/legacy_annotation/api.py#24)([RecipeApiPlain](/recipe_engine/recipe_api.py#735)):**
...
#### **class [MiloApi](/recipe_modules/milo/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [NodeJSApi](/recipe_modules/nodejs/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [PathApi](/recipe_modules/path/api.py#225)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#24)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#30)([RecipeApiPlain](/recipe_engine/recipe_api.py#735), collections.Mapping):**
...
#### **class [ProtoApi](/recipe_modules/proto/api.py#83)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [PythonApi](/recipe_modules/python/api.py#19)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [RandomApi](/recipe_modules/random/api.py#56)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [ResultDBAPI](/recipe_modules/resultdb/api.py#29)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [RuntimeApi](/recipe_modules/runtime/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [SchedulerApi](/recipe_modules/scheduler/api.py#28)([RecipeApi](/recipe_engine/recipe_api.py#883)):**

A module for interacting with LUCI Scheduler service.

&mdash; **def [emit\_trigger](/recipe_modules/scheduler/api.py#171)(self, trigger, project, jobs, step_name=None):**
...
&mdash; **def [emit\_triggers](/recipe_modules/scheduler/api.py#183)(self, trigger_project_jobs, timestamp_usec=None, step_name=None):**
...
#### **class [ServiceAccountApi](/recipe_modules/service_account/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#1103)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#1126)(self):**

Swarming bot ID executing this task.

&mdash; **def [collect](/recipe_modules/swarming/api.py#1255)(self, name, tasks, output_dir=None, task_output_stdout='json', timeout=None, eager=False, verbose=False):**
...
&emsp; **@property**<br>&mdash; **def [current\_server](/recipe_modules/swarming/api.py#1136)(self):**

Swarming server executing this task.

&mdash; **def [ensure\_client](/recipe_modules/swarming/api.py#1156)(self):**

&mdash; **def [initialize](/recipe_modules/swarming/api.py#1141)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1172)(self):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#1131)(self):**

This task's Swarming ID.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1186)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1197)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1205)(self, step_name, requests, verbose=False):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#26)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [UuidApi](/recipe_modules/uuid/api.py#11)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [VersionApi](/recipe_modules/version/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#883)):**
...
#### **class [WarningApi](/recipe_modules/warning/api.py#12)([RecipeApiPlain](/recipe_engine/recipe_api.py#735)):**
...
&mdash; **def [RunSteps](/recipe_modules/json/examples/full.py#22)(api):**
