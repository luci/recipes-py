...
#### **class [ArchiveApi](/recipe_modules/archive/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [AssertionsApi](/recipe_modules/assertions/api.py#56)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#29)([RecipeApi](/recipe_engine/recipe_api.py#837)):**

A module for interacting with buildbucket.

&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#839)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#855)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#860)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#865)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#607)(self, build_id, \*\*kwargs):**

&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#666)(self, build_id, mirror_status=False, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#686)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#645)(self, build_id, url_title_fn=None, step_name=None):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#662)(self, build_id, \*\*kwargs):**

DEPRECATED. Use get().

&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#610)(self, build_ids, url_title_fn=None, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [properties](/recipe_modules/buildbucket/api.py#850)(self):**

DEPRECATED, use build attribute instead.

&mdash; **def [put](/recipe_modules/buildbucket/api.py#511)(self, builds, \*\*kwargs):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#272)(self, schedule_build_requests, collect_interval=None, timeout=None, url_title_fn=None, step_name=None, raise_if_unsuccessful=False):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#435)(self, schedule_build_requests, url_title_fn=None, step_name=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#546)(self, predicate, limit=None, url_title_fn=None, step_name=None):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#199)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [CommitPositionApi](/recipe_modules/commit_position/api.py#10)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
&mdash; **def [record\_triggered\_build\_ids](/recipe_modules/cq/api.py#154)(self, \*build_ids):**
...
&mdash; **def [record\_triggered\_builds](/recipe_modules/cq/api.py#137)(self, \*builds):**
...
&emsp; **@property**<br>&mdash; **def [triggered\_build\_ids](/recipe_modules/cq/api.py#132)(self):**
...
#### **class [FileApi](/recipe_modules/file/api.py#81)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [IsolatedApi](/recipe_modules/isolated/api.py#14)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [JsonApi](/recipe_modules/json/api.py#89)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [LedApi](/recipe_modules/led/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [PathApi](/recipe_modules/path/api.py#197)([RecipeApi](/recipe_engine/recipe_api.py#837)):**

&mdash; **def [\_\_getitem\_\_](/recipe_modules/path/api.py#456)(self, name):**
...
&mdash; **def [assert\_absolute](/recipe_modules/path/api.py#326)(self, path):**
...
&mdash; **def [get](/recipe_modules/path/api.py#449)(self, name, default=None):**
...
&mdash; **def [mock\_add\_paths](/recipe_modules/path/api.py#305)(self, path):**

For testing purposes, mark that |path| exists.

&mdash; **def [mock\_copy\_paths](/recipe_modules/path/api.py#310)(self, source, dest):**

For testing purposes, copy |source| to |dest|.

&mdash; **def [mock\_remove\_paths](/recipe_modules/path/api.py#315)(self, path, filt=(lambda p: True)):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#18)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#28)([RecipeApiPlain](/recipe_engine/recipe_api.py#705), collections.Mapping):**
...
#### **class [PythonApi](/recipe_modules/python/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [RandomApi](/recipe_modules/random/api.py#31)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [RawIOApi](/recipe_modules/raw_io/api.py#255)([RecipeApi](/recipe_engine/recipe_api.py#837)):**

&emsp; **@[returns\_placeholder](/recipe_engine/util.py#135)**<br>&emsp; **@staticmethod**<br>&mdash; **def [input](/recipe_modules/raw_io/api.py#256)(data, suffix='', name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#135)**<br>&emsp; **@staticmethod**<br>&mdash; **def [input\_text](/recipe_modules/raw_io/api.py#274)(data, suffix='', name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#135)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output](/recipe_modules/raw_io/api.py#287)(suffix='', leak_to=None, name=None, add_output_log=False):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#135)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_dir](/recipe_modules/raw_io/api.py#325)(suffix='', leak_to=None, name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#135)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_text](/recipe_modules/raw_io/api.py#307)(suffix='', leak_to=None, name=None, add_output_log=False):**
...
#### **class [RuntimeApi](/recipe_modules/runtime/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [SchedulerApi](/recipe_modules/scheduler/api.py#26)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [ServiceAccountApi](/recipe_modules/service_account/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [SourceManfiestApi](/recipe_modules/source_manifest/api.py#32)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#774)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
&mdash; **def [collect](/recipe_modules/swarming/api.py#905)(self, name, tasks, output_dir=None, timeout=None):**
...
&mdash; **def [initialize](/recipe_modules/swarming/api.py#792)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#823)(self):**
...
&mdash; **def [task\_request](/recipe_modules/swarming/api.py#855)(self):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#866)(self, step_name, requests):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_server](/recipe_modules/swarming/api.py#837)(self, server):**
...
#### **class [TempfileApi](/recipe_modules/tempfile/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [TimeApi](/recipe_modules/time/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#13)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
...
#### **class [UuidApi](/recipe_modules/uuid/api.py#11)([RecipeApi](/recipe_engine/recipe_api.py#837)):**
