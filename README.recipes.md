...
&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#852)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#868)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#873)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#878)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#614)(self, build_id, \*\*kwargs):**

&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#677)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#690)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#656)(self, build_id, url_title_fn=None, step_name=None):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#673)(self, build_id, \*\*kwargs):**

DEPRECATED. Use get().

&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#617)(self, build_ids, url_title_fn=None, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [properties](/recipe_modules/buildbucket/api.py#863)(self):**

DEPRECATED, use build attribute instead.

&mdash; **def [put](/recipe_modules/buildbucket/api.py#518)(self, builds, \*\*kwargs):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#442)(self, schedule_build_requests, url_title_fn=None, step_name=None):**
...
&mdash; **def [schedule\_request](/recipe_modules/buildbucket/api.py#304)(self, builder, project=None, bucket=None, properties=None, experimental=None, gitiles_commit=None, gerrit_changes=None, tags=None, inherit_buildsets=True, dimensions=None, priority=None, critical=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#553)(self, predicate, limit=None, url_title_fn=None, step_name=None):**
...
&mdash; **def [ensure\_directory](/recipe_modules/file/api.py#342)(self, name, dest, mode=511):**
...
&mdash; **def [filesizes](/recipe_modules/file/api.py#359)(self, name, files, test_data=None):**
...
&mdash; **def [flatten\_single\_directories](/recipe_modules/file/api.py#475)(self, name, path):**
...
&mdash; **def [glob\_paths](/recipe_modules/file/api.py#275)(self, name, source, pattern, test_data=()):**
...
&mdash; **def [listdir](/recipe_modules/file/api.py#318)(self, name, source, test_data=()):**
...
&mdash; **def [remove](/recipe_modules/file/api.py#303)(self, name, source):**
...
&mdash; **def [rmcontents](/recipe_modules/file/api.py#398)(self, name, source):**
...
&mdash; **def [rmglob](/recipe_modules/file/api.py#416)(self, name, source, pattern):**
...
&mdash; **def [rmtree](/recipe_modules/file/api.py#381)(self, name, source):**
...
&mdash; **def [symlink](/recipe_modules/file/api.py#437)(self, name, source, linkname):**
...
&mdash; **def [symlink\_tree](/recipe_modules/file/api.py#454)(self, root):**
...
&mdash; **def [truncate](/recipe_modules/file/api.py#462)(self, name, path, size_mb=100):**
...
#### **class [PathApi](/recipe_modules/path/api.py#197)([RecipeApi](/recipe_engine/recipe_api.py#850)):**
...
#### **class [RawIOApi](/recipe_modules/raw_io/api.py#255)([RecipeApi](/recipe_engine/recipe_api.py#850)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#799)([RecipeApi](/recipe_engine/recipe_api.py#850)):**
...
&mdash; **def [collect](/recipe_modules/swarming/api.py#930)(self, name, tasks, output_dir=None, timeout=None):**
...
&mdash; **def [initialize](/recipe_modules/swarming/api.py#817)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#848)(self):**
...
&mdash; **def [task\_request](/recipe_modules/swarming/api.py#880)(self):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#891)(self, step_name, requests):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_server](/recipe_modules/swarming/api.py#862)(self, server):**
