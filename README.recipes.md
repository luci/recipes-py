...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#53)([RecipeApi](/recipe_engine/recipe_api.py#1006)):**

A module for interacting with buildbucket.

&emsp; **@property**<br>&mdash; **def [build](/recipe_modules/buildbucket/api.py#108)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#222)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#227)(self):**

DEPRECATED, use build.input instead.

&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#232)(self):**
...
&emsp; **@property**<br>&mdash; **def [properties](/recipe_modules/buildbucket/api.py#217)(self):**
...
&mdash; **def [set\_buildbucket\_host](/recipe_modules/buildbucket/api.py#86)(self, host):**
...
&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#124)(self):**

A dict of tags (key -> value) derived from current (parent) build for a
child build.

&mdash; **def [use\_service\_account\_key](/recipe_modules/buildbucket/api.py#94)(self, key_path):**
