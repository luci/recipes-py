...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#1020)([RecipeApi](/recipe_engine/recipe_api.py#871)):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#1042)(self):**

Swarming bot ID executing this task.

&mdash; **def [collect](/recipe_modules/swarming/api.py#1189)(self, name, tasks, output_dir=None, timeout=None):**
...
&mdash; **def [initialize](/recipe_modules/swarming/api.py#1052)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1089)(self):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#1047)(self):**

This task's Swarming ID.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1121)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1132)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1140)(self, step_name, requests, cancel_extra_tasks=False):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_server](/recipe_modules/swarming/api.py#1103)(self, server):**
