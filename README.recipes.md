...
#### **class [ArchiveApi](/recipe_modules/archive/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#223)(self):**

Returns bucket name in v1 format.

Mostly useful for scheduling new builds using V1 API.

&emsp; **@property**<br>&mdash; **def [build](/recipe_modules/buildbucket/api.py#93)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#239)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#244)(self):**

DEPRECATED, use build.input instead.

&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#249)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#193)(self, build_id, \*\*kwargs):**

&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#196)(self, build_id, \*\*kwargs):**

&emsp; **@property**<br>&mdash; **def [gitiles\_commit](/recipe_modules/buildbucket/api.py#117)(self):**

Returns input gitiles commit. Shortcut for .build.input.gitiles_commit.

Never returns None, but sub-fields may be empty.

&emsp; **@property**<br>&mdash; **def [properties](/recipe_modules/buildbucket/api.py#234)(self):**

DEPRECATED, use build attribute instead.

&mdash; **def [put](/recipe_modules/buildbucket/api.py#164)(self, builds, \*\*kwargs):**
...
&mdash; **def [set\_buildbucket\_host](/recipe_modules/buildbucket/api.py#71)(self, host):**
...
&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#125)(self):**

A dict of tags (key -> value) derived from current (parent) build for a
child build.

&mdash; **def [use\_service\_account\_key](/recipe_modules/buildbucket/api.py#79)(self, key_path):**
...
#### **class [ContextApi](/recipe_modules/context/api.py#49)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [FileApi](/recipe_modules/file/api.py#18)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
&mdash; **def [copytree](/recipe_modules/file/api.py#74)(self, name, source, dest, symlinks=False):**
...
&mdash; **def [ensure\_directory](/recipe_modules/file/api.py#246)(self, name, dest, mode=511):**
...
&mdash; **def [filesizes](/recipe_modules/file/api.py#263)(self, name, files, test_data=None):**
...
&mdash; **def [listdir](/recipe_modules/file/api.py#222)(self, name, source, test_data=()):**
...
&mdash; **def [move](/recipe_modules/file/api.py#95)(self, name, source, dest):**
...
&mdash; **def [read\_raw](/recipe_modules/file/api.py#113)(self, name, source, test_data=''):**
...
&mdash; **def [read\_text](/recipe_modules/file/api.py#146)(self, name, source, test_data=''):**
...
&mdash; **def [remove](/recipe_modules/file/api.py#207)(self, name, source):**
...
&mdash; **def [rmcontents](/recipe_modules/file/api.py#302)(self, name, source):**
...
&mdash; **def [rmglob](/recipe_modules/file/api.py#320)(self, name, source, pattern):**
...
&mdash; **def [rmtree](/recipe_modules/file/api.py#285)(self, name, source):**
...
&mdash; **def [symlink](/recipe_modules/file/api.py#341)(self, name, source, link):**
...
&mdash; **def [truncate](/recipe_modules/file/api.py#358)(self, name, path, size_mb=100):**
...
&mdash; **def [write\_raw](/recipe_modules/file/api.py#132)(self, name, dest, data):**
...
&mdash; **def [write\_text](/recipe_modules/file/api.py#165)(self, name, dest, text_data):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [JsonApi](/recipe_modules/json/api.py#83)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [LedApi](/recipe_modules/led/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [PathApi](/recipe_modules/path/api.py#197)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#18)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#28)([RecipeApiPlain](/recipe_engine/recipe_api.py#880), collections.Mapping):**
...
#### **class [PythonApi](/recipe_modules/python/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [RuntimeApi](/recipe_modules/runtime/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [SchedulerApi](/recipe_modules/scheduler/api.py#21)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [ServiceAccountApi](/recipe_modules/service_account/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [SourceManfiestApi](/recipe_modules/source_manifest/api.py#32)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [StepApi](/recipe_modules/step/api.py#19)([RecipeApiPlain](/recipe_engine/recipe_api.py#880)):**
...
#### **class [TempfileApi](/recipe_modules/tempfile/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#13)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#1012)):**
