...
#### **class [ArchiveApi](/recipe_modules/archive/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [BuildbucketApi](/recipe_modules/buildbucket/api.py#23)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**

A module for interacting with buildbucket.

&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#561)(self):**

Returns bucket name in v1 format.

Mostly useful for scheduling new builds using V1 API.

&emsp; **@property**<br>&mdash; **def [build](/recipe_modules/buildbucket/api.py#101)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#577)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#582)(self):**

DEPRECATED, use build.input instead.

&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#587)(self):**

Deprecated. Use build.builder instead.

&emsp; **@property**<br>&mdash; **def [builder\_name](/recipe_modules/buildbucket/api.py#120)(self):**

Returns builder name. Shortcut for `.build.builder.builder`.

&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#470)(self, build_id, \*\*kwargs):**

&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#476)(self, build_id, mirror_status=False, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#496)(self, build_ids, interval=None, timeout=None, step_name=None):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#473)(self, build_id, \*\*kwargs):**
...
&emsp; **@property**<br>&mdash; **def [properties](/recipe_modules/buildbucket/api.py#572)(self):**

DEPRECATED, use build attribute instead.

&mdash; **def [put](/recipe_modules/buildbucket/api.py#435)(self, builds, \*\*kwargs):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#222)(self, schedule_build_requests, collect_interval=None, timeout=None, step_name=None):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#352)(self, schedule_build_requests, step_name=None):**
...
&mdash; **def [schedule\_request](/recipe_modules/buildbucket/api.py#244)(self, builder, project=None, bucket=None, properties=None, experimental=None, gitiles_commit=None, gerrit_changes=None, tags=None, inherit_buildsets=True, dimensions=None, priority=None):**
...
&mdash; **def [set\_buildbucket\_host](/recipe_modules/buildbucket/api.py#79)(self, host):**
...
&mdash; **def [set\_output\_gitiles\_commit](/recipe_modules/buildbucket/api.py#173)(self, gitiles_commit):**
...
&mdash; **def [tags](/recipe_modules/buildbucket/api.py#216)(self, \*\*tags):**

Alias for tags in util.py. See doc there.

&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#136)(self):**

A dict of tags (key -> value) derived from current (parent) build for a
child build.

&mdash; **def [use\_service\_account\_key](/recipe_modules/buildbucket/api.py#87)(self, key_path):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#199)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [ContextApi](/recipe_modules/context/api.py#49)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [FileApi](/recipe_modules/file/api.py#80)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [IsolatedApi](/recipe_modules/isolated/api.py#13)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
&mdash; **def [download](/recipe_modules/isolated/api.py#92)(self, step_name, isolated_hash, output_dir, isolate_server=None):**
...
&mdash; **def [isolated](/recipe_modules/isolated/api.py#82)(self, root_dir):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/isolated/api.py#68)(self):**
...
#### **class [JsonApi](/recipe_modules/json/api.py#83)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#132)**<br>&mdash; **def [output](/recipe_modules/json/api.py#107)(self, add_json_log=True, name=None, leak_to=None):**
...
#### **class [LedApi](/recipe_modules/led/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [PathApi](/recipe_modules/path/api.py#197)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
&mdash; **def [abs\_to\_path](/recipe_modules/path/api.py#387)(self, abs_string_path):**
...
&mdash; **def [get](/recipe_modules/path/api.py#450)(self, name, default=None):**
...
&mdash; **def [mkstemp](/recipe_modules/path/api.py#360)(self, prefix=tempfile.template):**
...
#### **class [PlatformApi](/recipe_modules/platform/api.py#18)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [PropertiesApi](/recipe_modules/properties/api.py#28)([RecipeApiPlain](/recipe_engine/recipe_api.py#873), collections.Mapping):**
...
#### **class [PythonApi](/recipe_modules/python/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [RandomApi](/recipe_modules/random/api.py#31)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [RawIOApi](/recipe_modules/raw_io/api.py#255)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#132)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output](/recipe_modules/raw_io/api.py#287)(suffix='', leak_to=None, name=None, add_output_log=False):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#132)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_dir](/recipe_modules/raw_io/api.py#325)(suffix='', leak_to=None, name=None):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#132)**<br>&emsp; **@staticmethod**<br>&mdash; **def [output\_text](/recipe_modules/raw_io/api.py#307)(suffix='', leak_to=None, name=None, add_output_log=False):**
...
#### **class [RuntimeApi](/recipe_modules/runtime/api.py#8)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [SchedulerApi](/recipe_modules/scheduler/api.py#20)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**

A module for interacting with LUCI Scheduler service.

&mdash; **def [emit\_trigger](/recipe_modules/scheduler/api.py#107)(self, trigger, project, jobs, step_name=None):**
...
&mdash; **def [emit\_triggers](/recipe_modules/scheduler/api.py#119)(self, trigger_project_jobs, timestamp_usec=None, step_name=None):**
...
#### **class [ServiceAccountApi](/recipe_modules/service_account/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [SourceManfiestApi](/recipe_modules/source_manifest/api.py#32)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [StepApi](/recipe_modules/step/api.py#19)([RecipeApiPlain](/recipe_engine/recipe_api.py#873)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#677)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
&mdash; **def [collect](/recipe_modules/swarming/api.py#790)(self, name, tasks, output_dir=None, timeout=None):**
...
&mdash; **def [initialize](/recipe_modules/swarming/api.py#695)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#726)(self):**
...
&mdash; **def [task\_request](/recipe_modules/swarming/api.py#740)(self):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#751)(self, step_name, requests):**
...
#### **class [TempfileApi](/recipe_modules/tempfile/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [TimeApi](/recipe_modules/time/api.py#12)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#13)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [UrlApi](/recipe_modules/url/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
#### **class [UuidApi](/recipe_modules/uuid/api.py#11)([RecipeApi](/recipe_engine/recipe_api.py#1005)):**
...
[DEPS](/recipe_modules/buildbucket/tests/schedule.py#7): [buildbucket](#recipe_modules-buildbucket), [properties](#recipe_modules-properties), [runtime](#recipe_modules-runtime), [step](#recipe_modules-step)

&mdash; **def [RunSteps](/recipe_modules/buildbucket/tests/schedule.py#15)(api):**
