...
&mdash; **def [add\_instance\_link](/recipe_modules/cipd/api.py#610)(self, step_result):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#654)(self, pkg_def, refs=None, tags=None, metadata=None, compression_level: (CompressionLevel | None)=None, verification_timeout=None):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#616)(self, pkg_def, refs=None, tags=None, metadata=None, pkg_vars=None, compression_level: (CompressionLevel | None)=None, verification_timeout=None):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#873)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#689)(self, root, ensure_file, name='ensure_installed'):**
...
&mdash; **def [ensure\_file\_resolve](/recipe_modules/cipd/api.py#731)(self, ensure_file, name='cipd ensure-file-resolve'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#999)(self, package: str, version: str, executable_path: str=None):**
...
&mdash; **def [instances](/recipe_modules/cipd/api.py#908)(self, package_name, limit=None):**
...
&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#975)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#945)(self, destination, package_name, version):**
...
&emsp; **@property**<br>&mdash; **def [platform](/recipe_modules/cipd/api.py#1075)(self):**

Returns the CIPD platform string, equivalent to '${platform}'.

&mdash; **def [register](/recipe_modules/cipd/api.py#540)(self, package_name, package_path, refs=None, tags=None, metadata=None, verification_timeout=None):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#841)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_metadata](/recipe_modules/cipd/api.py#789)(self, package_name, version, metadata):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#815)(self, package_name, version, refs):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#761)(self, package_name, version, tags):**
