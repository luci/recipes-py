...
&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#869)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#880)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#885)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#890)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#629)(self, build_id, \*\*kwargs):**

&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#692)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#705)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#671)(self, build_id, url_title_fn=None, step_name=None):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#688)(self, build_id, \*\*kwargs):**

DEPRECATED. Use get().

&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#632)(self, build_ids, url_title_fn=None, step_name=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#568)(self, predicate, limit=None, url_title_fn=None, step_name=None):**
