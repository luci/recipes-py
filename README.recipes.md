...
&mdash; **def [collect](/recipe_modules/swarming/api.py#1345)(self, name, tasks, output_dir=None, task_output_stdout='json', timeout=None, eager=False, verbose=False):**
...
&mdash; **def [ensure\_client](/recipe_modules/swarming/api.py#1245)(self):**

&mdash; **def [initialize](/recipe_modules/swarming/api.py#1222)(self):**

&mdash; **def [list\_bots](/recipe_modules/swarming/api.py#1471)(self, step_name, dimensions=None, fields=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1261)(self):**
...
&mdash; **def [show\_request](/recipe_modules/swarming/api.py#1434)(self, name, task):**
...
&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1275)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1286)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1294)(self, step_name, requests, verbose=False):**
