...
**[Recipes](#Recipes)**
  ...
  * [isolated:examples/full](#recipes-isolated_examples_full) (Python3 ✅)
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#254)([RecipeApi](/recipe_engine/recipe_api.py#881)):**
...
&mdash; **def [acl\_check](/recipe_modules/cipd/api.py#370)(self, pkg_path, reader=True, writer=False, owner=False):**
...
&mdash; **def [add\_instance\_link](/recipe_modules/cipd/api.py#615)(self, step_result):**

&mdash; **def [build](/recipe_modules/cipd/api.py#468)(self, input_dir, output_package, package_name, compression_level=None, install_mode=None, preserve_mtime=False, preserve_writable=False):**
...
&mdash; **def [build\_from\_pkg](/recipe_modules/cipd/api.py#448)(self, pkg_def, output_package, compression_level=None):**
...
&mdash; **def [build\_from\_yaml](/recipe_modules/cipd/api.py#422)(self, pkg_def, output_package, pkg_vars=None, compression_level=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [cache\_dir](/recipe_modules/cipd/api.py#343)(self, directory):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#659)(self, pkg_def, refs=None, tags=None, metadata=None, compression_level=None, verification_timeout=None):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#621)(self, pkg_def, refs=None, tags=None, metadata=None, pkg_vars=None, compression_level=None, verification_timeout=None):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#845)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#694)(self, root, ensure_file, name='ensure_installed'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#972)(self, package, version, executable_path=None):**
...
&emsp; **@property**<br>&mdash; **def [executable](/recipe_modules/cipd/api.py#355)(self):**

&mdash; **def [instances](/recipe_modules/cipd/api.py#880)(self, package_name, limit=None):**
...
&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#949)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#918)(self, destination, package_name, version):**
...
&mdash; **def [register](/recipe_modules/cipd/api.py#548)(self, package_name, package_path, refs=None, tags=None, metadata=None):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#813)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_metadata](/recipe_modules/cipd/api.py#763)(self, package_name, version, metadata):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#788)(self, package_name, version, refs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [set\_service\_account](/recipe_modules/cipd/api.py#321)(self, service_account):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#736)(self, package_name, version, tags):**
...
&mdash; **def [read\_json](/recipe_modules/file/api.py#344)(self, name, source, test_data='', include_log=True):**
...
&mdash; **def [read\_text](/recipe_modules/file/api.py#302)(self, name, source, test_data='', include_log=True):**
...
&mdash; **def [write\_json](/recipe_modules/file/api.py#364)(self, name, dest, data, indent=None, include_log=True):**
...
&mdash; **def [write\_text](/recipe_modules/file/api.py#326)(self, name, dest, text_data, include_log=True):**
...
[DEPS](/recipe_modules/isolated/__init__.py#7): [properties](#recipe_modules-properties)
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#156)**<br>&mdash; **def [input](/recipe_modules/json/api.py#133)(self, data):**

A placeholder which will expand to a file path containing <data>.

&mdash; **def [is\_serializable](/recipe_modules/json/api.py#125)(self, obj):**

Returns True if the object is JSON-serializable.

&emsp; **@staticmethod**<br>&mdash; **def [loads](/recipe_modules/json/api.py#115)(data, \*\*kwargs):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#156)**<br>&mdash; **def [output](/recipe_modules/json/api.py#138)(self, add_json_log=True, name=None, leak_to=None):**
...
&mdash; **def [read](/recipe_modules/json/api.py#153)(self, name, path, add_json_log=True, output_name=None, \*\*kwargs):**
...
&mdash; **def [\_\_call\_\_](/recipe_modules/led/api.py#178)(self, \*cmd):**

Runs led with the given arguments. Wraps result in a `LedResult`.

&emsp; **@property**<br>&mdash; **def [cipd\_input](/recipe_modules/led/api.py#170)(self):**
...
&mdash; **def [initialize](/recipe_modules/led/api.py#123)(self):**

&mdash; **def [inject\_input\_recipes](/recipe_modules/led/api.py#182)(self, led_result):**
...
&emsp; **@property**<br>&mdash; **def [isolated\_input](/recipe_modules/led/api.py#152)(self):**
...
&emsp; **@property**<br>&mdash; **def [launched\_by\_led](/recipe_modules/led/api.py#139)(self):**

Whether the current build is a led job.

&emsp; **@property**<br>&mdash; **def [rbe\_cas\_input](/recipe_modules/led/api.py#161)(self):**
...
&emsp; **@property**<br>&mdash; **def [run\_id](/recipe_modules/led/api.py#144)(self):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#1259)([RecipeApi](/recipe_engine/recipe_api.py#881)):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#1282)(self):**

Swarming bot ID executing this task.

&mdash; **def [collect](/recipe_modules/swarming/api.py#1425)(self, name, tasks, output_dir=None, task_output_stdout='json', timeout=None, eager=False, verbose=False):**
...
&mdash; **def [ensure\_client](/recipe_modules/swarming/api.py#1309)(self):**

&mdash; **def [initialize](/recipe_modules/swarming/api.py#1292)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1324)(self):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#1287)(self):**

This task's Swarming ID.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1356)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1367)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1375)(self, step_name, requests, verbose=False):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_server](/recipe_modules/swarming/api.py#1338)(self, server):**
...
[DEPS](/recipe_modules/isolated/examples/full.py#7): [isolated](#recipe_modules-isolated)

PYTHON_VERSION_COMPATIBILITY: PY2+3

&mdash; **def [RunSteps](/recipe_modules/isolated/examples/full.py#12)(api):**
