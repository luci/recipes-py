...
#### **class [StepApi](/recipe_modules/step/api.py#30)([RecipeApi](/recipe_engine/recipe_api.py#439)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#1236)([RecipeApi](/recipe_engine/recipe_api.py#439)):**
...
&mdash; **def [exponential\_retry](/recipe_modules/time/api.py#128)(self, retries: int, delay: datetime.timedelta, condition: Callable[([Exception], bool)]=None):**
...
&mdash; **def [ms\_since\_epoch](/recipe_modules/time/api.py#210)(self):**
...
&mdash; **def [time](/recipe_modules/time/api.py#202)(self):**

Returns current timestamp as a float number of seconds since epoch.

&mdash; **def [timeout](/recipe_modules/time/api.py#233)(self, seconds: ((float | int) | datetime.timedelta)=None):**
...
&mdash; **def [utcnow](/recipe_modules/time/api.py#215)(self):**
