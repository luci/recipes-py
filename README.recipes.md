...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#200)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#205)(self):**

DEPRECATED, use build.input instead.

&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#210)(self):**

Deprecated. Use build.builder instead.

&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#163)(self, build_id, \*\*kwargs):**

&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#166)(self, build_id, \*\*kwargs):**

&emsp; **@property**<br>&mdash; **def [properties](/recipe_modules/buildbucket/api.py#195)(self):**

DEPRECATED, use build attribute instead.

&mdash; **def [put](/recipe_modules/buildbucket/api.py#134)(self, builds, \*\*kwargs):**
