...
&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#843)(self):**
...
&mdash; **def [build\_url](/recipe_modules/buildbucket/api.py#123)(self, host=None, build_id=None):**

Returns url to a build. Defaults to current build.

&emsp; **@property**<br>&mdash; **def [builder\_cache\_path](/recipe_modules/buildbucket/api.py#229)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#603)(self, build_id, \*\*kwargs):**

&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#666)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#679)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False):**
...
&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#606)(self, build_ids, url_title_fn=None, step_name=None):**
...
&emsp; **@property**<br>&mdash; **def [gitiles\_commit](/recipe_modules/buildbucket/api.py#128)(self):**
...
&emsp; **@host.setter**<br>&mdash; **def [host](/recipe_modules/buildbucket/api.py#77)(self, value):**

&mdash; **def [is\_critical](/recipe_modules/buildbucket/api.py#139)(self, build=None):**

Returns True if the build is critical. Build defaults to the current one.
    

&mdash; **def [put](/recipe_modules/buildbucket/api.py#507)(self, builds, \*\*kwargs):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#260)(self, schedule_build_requests, collect_interval=None, timeout=None, url_title_fn=None, step_name=None, raise_if_unsuccessful=False):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#431)(self, schedule_build_requests, url_title_fn=None, step_name=None):**
...
&mdash; **def [schedule\_request](/recipe_modules/buildbucket/api.py#288)(self, builder, project=None, bucket=None, properties=None, experimental=None, gitiles_commit=None, gerrit_changes=None, tags=None, inherit_buildsets=True, dimensions=None, priority=None, critical=None, exe_cipd_version=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#542)(self, predicate, limit=None, url_title_fn=None, step_name=None):**
...
&mdash; **def [set\_buildbucket\_host](/recipe_modules/buildbucket/api.py#81)(self, host):**

DEPRECATED. Use host property.

&mdash; **def [set\_output\_gitiles\_commit](/recipe_modules/buildbucket/api.py#182)(self, gitiles_commit):**
...
&mdash; **def [tags](/recipe_modules/buildbucket/api.py#225)(self, \*\*tags):**

Alias for tags in util.py. See doc there.

&emsp; **@property**<br>&mdash; **def [tags\_for\_child\_build](/recipe_modules/buildbucket/api.py#145)(self):**
