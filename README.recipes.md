...
&mdash; **def [add\_tags\_to\_current\_build](/recipe_modules/buildbucket/api.py#278)(self, tags):**
...
&emsp; **@property**<br>&mdash; **def [builder\_cache\_path](/recipe_modules/buildbucket/api.py#303)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#698)(self, build_id, reason=' ', step_name=None):**
...
&mdash; **def [collect\_build](/recipe_modules/buildbucket/api.py#804)(self, build_id, \*\*kwargs):**
...
&mdash; **def [collect\_builds](/recipe_modules/buildbucket/api.py#817)(self, build_ids, interval=None, timeout=None, step_name=None, raise_if_unsuccessful=False, url_title_fn=None, mirror_status=False, fields=DEFAULT_FIELDS):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#779)(self, build_id, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#800)(self, build_id, \*\*kwargs):**

DEPRECATED. Use get().

&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#736)(self, build_ids, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [hide\_current\_build\_in\_gerrit](/recipe_modules/buildbucket/api.py#299)(self):**
...
&mdash; **def [put](/recipe_modules/buildbucket/api.py#598)(self, builds, \*\*kwargs):**
...
&mdash; **def [run](/recipe_modules/buildbucket/api.py#324)(self, schedule_build_requests, collect_interval=None, timeout=None, url_title_fn=None, step_name=None, raise_if_unsuccessful=False):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#522)(self, schedule_build_requests, url_title_fn=None, step_name=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#633)(self, predicate, limit=None, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&emsp; **@staticmethod**<br>&mdash; **def [tags](/recipe_modules/buildbucket/api.py#273)(\*\*tags):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#204)([RecipeApi](/recipe_engine/recipe_api.py#875)):**
...
&mdash; **def [acl\_check](/recipe_modules/cipd/api.py#311)(self, pkg_path, reader=True, writer=False, owner=False):**
...
&mdash; **def [add\_instance\_link](/recipe_modules/cipd/api.py#543)(self, step_result):**

&mdash; **def [build](/recipe_modules/cipd/api.py#409)(self, input_dir, output_package, package_name, compression_level=None, install_mode=None, preserve_mtime=False, preserve_writable=False):**
...
&mdash; **def [build\_from\_pkg](/recipe_modules/cipd/api.py#389)(self, pkg_def, output_package, compression_level=None):**
...
&mdash; **def [build\_from\_yaml](/recipe_modules/cipd/api.py#363)(self, pkg_def, output_package, pkg_vars=None, compression_level=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [cache\_dir](/recipe_modules/cipd/api.py#284)(self, directory):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#577)(self, pkg_def, refs=None, tags=None, compression_level=None):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#549)(self, pkg_def, refs=None, tags=None, pkg_vars=None, compression_level=None):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#716)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#605)(self, root, ensure_file, name='ensure_installed'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#805)(self, package, version, executable_path=None):**
...
&emsp; **@property**<br>&mdash; **def [executable](/recipe_modules/cipd/api.py#296)(self):**

&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#782)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#751)(self, destination, package_name, version):**
...
&mdash; **def [register](/recipe_modules/cipd/api.py#483)(self, package_name, package_path, refs=(), tags=None):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#684)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#659)(self, package_name, version, refs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [set\_service\_account](/recipe_modules/cipd/api.py#262)(self, service_account):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#632)(self, package_name, version, tags):**
...
&emsp; **@property**<br>&mdash; **def [do\_not\_retry\_build](/recipe_modules/cq/api.py#197)(self):**
...
&mdash; **def [initialize](/recipe_modules/cq/api.py#47)(self):**
...
&mdash; **def [set\_do\_not\_retry\_build](/recipe_modules/cq/api.py#201)(self):**
...
&emsp; **@property**<br>&mdash; **def [state](/recipe_modules/cq/api.py#60)(self):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#151)**<br>&mdash; **def [input](/recipe_modules/json/api.py#120)(self, data):**
...
&emsp; **@[returns\_placeholder](/recipe_engine/util.py#151)**<br>&mdash; **def [output](/recipe_modules/json/api.py#125)(self, add_json_log=True, name=None, leak_to=None):**
