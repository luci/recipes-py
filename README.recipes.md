...
&emsp; **@property**<br>&mdash; **def [bucket\_v1](/recipe_modules/buildbucket/api.py#989)(self):**
...
&emsp; **@property**<br>&mdash; **def [build\_id](/recipe_modules/buildbucket/api.py#1000)(self):**

DEPRECATED, use build.id instead.

&emsp; **@property**<br>&mdash; **def [build\_input](/recipe_modules/buildbucket/api.py#1005)(self):**
...
&emsp; **@property**<br>&mdash; **def [builder\_id](/recipe_modules/buildbucket/api.py#1010)(self):**
...
&mdash; **def [cancel\_build](/recipe_modules/buildbucket/api.py#692)(self, build_id, reason=' ', step_name=None):**
...
&mdash; **def [get](/recipe_modules/buildbucket/api.py#773)(self, build_id, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [get\_build](/recipe_modules/buildbucket/api.py#794)(self, build_id, \*\*kwargs):**

DEPRECATED. Use get().

&mdash; **def [get\_multi](/recipe_modules/buildbucket/api.py#730)(self, build_ids, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
&mdash; **def [put](/recipe_modules/buildbucket/api.py#592)(self, builds, \*\*kwargs):**
...
&mdash; **def [schedule](/recipe_modules/buildbucket/api.py#516)(self, schedule_build_requests, url_title_fn=None, step_name=None):**
...
&mdash; **def [search](/recipe_modules/buildbucket/api.py#627)(self, predicate, limit=None, url_title_fn=None, step_name=None, fields=DEFAULT_FIELDS):**
...
[DEPS](/recipe_modules/cas/__init__.py#7): [cipd](#recipe_modules-cipd), [context](#recipe_modules-context), [path](#recipe_modules-path), [properties](#recipe_modules-properties), [raw\_io](#recipe_modules-raw_io), [runtime](#recipe_modules-runtime), [step](#recipe_modules-step)

API for interacting with cas client.

#### **class [CasApi](/recipe_modules/cas/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#856)):**

A module for interacting with cas client.

&mdash; **def [\_\_init\_\_](/recipe_modules/cas/api.py#19)(self, props, \*\*kwargs):**
...
&mdash; **def [archive](/recipe_modules/cas/api.py#95)(self, step_name, root, \*paths):**
...
&mdash; **def [download](/recipe_modules/cas/api.py#75)(self, step_name, digest, output_dir):**
...
&emsp; **@property**<br>&mdash; **def [instance](/recipe_modules/cas/api.py#30)(self):**
...
#### **class [CIPDApi](/recipe_modules/cipd/api.py#203)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
&mdash; **def [acl\_check](/recipe_modules/cipd/api.py#310)(self, pkg_path, reader=True, writer=False, owner=False):**
...
&mdash; **def [add\_instance\_link](/recipe_modules/cipd/api.py#542)(self, step_result):**

&mdash; **def [build](/recipe_modules/cipd/api.py#408)(self, input_dir, output_package, package_name, compression_level=None, install_mode=None, preserve_mtime=False, preserve_writable=False):**
...
&mdash; **def [build\_from\_pkg](/recipe_modules/cipd/api.py#388)(self, pkg_def, output_package, compression_level=None):**
...
&mdash; **def [build\_from\_yaml](/recipe_modules/cipd/api.py#362)(self, pkg_def, output_package, pkg_vars=None, compression_level=None):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [cache\_dir](/recipe_modules/cipd/api.py#283)(self, directory):**
...
&mdash; **def [create\_from\_pkg](/recipe_modules/cipd/api.py#576)(self, pkg_def, refs=None, tags=None, compression_level=None):**
...
&mdash; **def [create\_from\_yaml](/recipe_modules/cipd/api.py#548)(self, pkg_def, refs=None, tags=None, pkg_vars=None, compression_level=None):**
...
&mdash; **def [describe](/recipe_modules/cipd/api.py#715)(self, package_name, version, test_data_refs=None, test_data_tags=None):**
...
&mdash; **def [ensure](/recipe_modules/cipd/api.py#604)(self, root, ensure_file, name='ensure_installed'):**
...
&mdash; **def [ensure\_tool](/recipe_modules/cipd/api.py#804)(self, package, version, executable_path=None):**
...
&emsp; **@property**<br>&mdash; **def [executable](/recipe_modules/cipd/api.py#295)(self):**

&mdash; **def [pkg\_deploy](/recipe_modules/cipd/api.py#781)(self, root, package_file):**
...
&mdash; **def [pkg\_fetch](/recipe_modules/cipd/api.py#750)(self, destination, package_name, version):**
...
&mdash; **def [register](/recipe_modules/cipd/api.py#482)(self, package_name, package_path, refs=(), tags=None):**
...
&mdash; **def [search](/recipe_modules/cipd/api.py#683)(self, package_name, tag, test_instances=None):**
...
&mdash; **def [set\_ref](/recipe_modules/cipd/api.py#658)(self, package_name, version, refs):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [set\_service\_account](/recipe_modules/cipd/api.py#261)(self, service_account):**
...
&mdash; **def [set\_tag](/recipe_modules/cipd/api.py#631)(self, package_name, version, tags):**
...
#### **class [CQApi](/recipe_modules/cq/api.py#16)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
#### **class [FileApi](/recipe_modules/file/api.py#84)([RecipeApi](/recipe_engine/recipe_api.py#856)):**

&mdash; **def [compute\_hash](/recipe_modules/file/api.py#183)(self, name, paths, base_path, test_data=''):**
...
&mdash; **def [ensure\_directory](/recipe_modules/file/api.py#488)(self, name, dest, mode=511):**
...
&mdash; **def [filesizes](/recipe_modules/file/api.py#504)(self, name, files, test_data=None):**
...
&mdash; **def [flatten\_single\_directories](/recipe_modules/file/api.py#644)(self, name, path):**
...
&mdash; **def [glob\_paths](/recipe_modules/file/api.py#396)(self, name, source, pattern, include_hidden=False, test_data=()):**
...
&mdash; **def [listdir](/recipe_modules/file/api.py#458)(self, name, source, recursive=False, test_data=()):**
...
&mdash; **def [read\_proto](/recipe_modules/file/api.py#348)(self, name, source, msg_class, codec, test_proto=None, include_log=True):**
...
&mdash; **def [remove](/recipe_modules/file/api.py#443)(self, name, source):**
...
&mdash; **def [rmcontents](/recipe_modules/file/api.py#543)(self, name, source):**
...
&mdash; **def [rmglob](/recipe_modules/file/api.py#561)(self, name, source, pattern, recursive=True, include_hidden=True):**
...
&mdash; **def [rmtree](/recipe_modules/file/api.py#526)(self, name, source):**
...
&mdash; **def [symlink](/recipe_modules/file/api.py#606)(self, name, source, linkname):**
...
&mdash; **def [symlink\_tree](/recipe_modules/file/api.py#623)(self, root):**
...
&mdash; **def [truncate](/recipe_modules/file/api.py#631)(self, name, path, size_mb=100):**
...
&mdash; **def [write\_json](/recipe_modules/file/api.py#332)(self, name, dest, data, indent=None, include_log=True):**
...
&mdash; **def [write\_proto](/recipe_modules/file/api.py#379)(self, name, dest, proto_msg, codec, include_log=True):**
...
#### **class [GeneratorScriptApi](/recipe_modules/generator_script/api.py#15)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
#### **class [JsonApi](/recipe_modules/json/api.py#96)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
#### **class [LedApi](/recipe_modules/led/api.py#17)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
#### **class [PathApi](/recipe_modules/path/api.py#201)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
#### **class [StepApi](/recipe_modules/step/api.py#25)([RecipeApiPlain](/recipe_engine/recipe_api.py#708)):**
...
#### **class [SwarmingApi](/recipe_modules/swarming/api.py#1217)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
...
&emsp; **@property**<br>&mdash; **def [bot\_id](/recipe_modules/swarming/api.py#1240)(self):**

Swarming bot ID executing this task.

&mdash; **def [collect](/recipe_modules/swarming/api.py#1383)(self, name, tasks, output_dir=None, task_output_stdout='json', timeout=None, eager=False, verbose=False):**
...
&mdash; **def [ensure\_client](/recipe_modules/swarming/api.py#1267)(self):**

&mdash; **def [initialize](/recipe_modules/swarming/api.py#1250)(self):**

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [on\_path](/recipe_modules/swarming/api.py#1282)(self):**
...
&emsp; **@property**<br>&mdash; **def [task\_id](/recipe_modules/swarming/api.py#1245)(self):**

This task's Swarming ID.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#1314)(self):**
...
&mdash; **def [task\_request\_from\_jsonish](/recipe_modules/swarming/api.py#1325)(self, json_d):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#1333)(self, step_name, requests, verbose=False):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [with\_server](/recipe_modules/swarming/api.py#1296)(self, server):**
...
#### **class [TriciumApi](/recipe_modules/tricium/api.py#26)([RecipeApi](/recipe_engine/recipe_api.py#856)):**
