...
_STEP_MANIFESTLINK = _descriptor.Descriptor(
  name='ManifestLink',
  full_name='milo.Step.ManifestLink',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='milo.Step.ManifestLink.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sha256', full_name='milo.Step.ManifestLink.sha256', index=1,
...
_STEP_SOURCEMANIFESTSENTRY = _descriptor.Descriptor(
  name='SourceManifestsEntry',
  full_name='milo.Step.SourceManifestsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='milo.Step.SourceManifestsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='milo.Step.SourceManifestsEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_manifests', full_name='milo.Step.source_manifests', index=14,
  ...
  nested_types=[_STEP_COMMAND, _STEP_SUBSTEP, _STEP_PROGRESS, _STEP_PROPERTY, _STEP_MANIFESTLINK, _STEP_SOURCEMANIFESTSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_STEP_MANIFESTLINK.containing_type = _STEP
_STEP_SOURCEMANIFESTSENTRY.fields_by_name['value'].message_type = _STEP_MANIFESTLINK
_STEP_SOURCEMANIFESTSENTRY.containing_type = _STEP
...
_STEP.fields_by_name['source_manifests'].message_type = _STEP_SOURCEMANIFESTSENTRY
...
Step = _reflection.GeneratedProtocolMessageType('Step', (_message.Message,), dict(
  ...
  ManifestLink = _reflection.GeneratedProtocolMessageType('ManifestLink', (_message.Message,), dict(
    DESCRIPTOR = _STEP_MANIFESTLINK,
    __module__ = 'annotations_pb2'
    # @@protoc_insertion_point(class_scope:milo.Step.ManifestLink)
    ))
  ,

  SourceManifestsEntry = _reflection.GeneratedProtocolMessageType('SourceManifestsEntry', (_message.Message,), dict(
    DESCRIPTOR = _STEP_SOURCEMANIFESTSENTRY,
    __module__ = 'annotations_pb2'
    # @@protoc_insertion_point(class_scope:milo.Step.SourceManifestsEntry)
    ))
  ,
  DESCRIPTOR = _STEP,
  __module__ = 'annotations_pb2'
...
_sym_db.RegisterMessage(Step.ManifestLink)
_sym_db.RegisterMessage(Step.SourceManifestsEntry)
...
_STEP_SOURCEMANIFESTSENTRY.has_options = True
_STEP_SOURCEMANIFESTSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
